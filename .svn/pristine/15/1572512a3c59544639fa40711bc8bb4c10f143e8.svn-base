...
SMStateBase  *SMEnterWtForPriceEmbeddedBase::Initialize(void)
{
  ...
  //+tar 330491
  m_pAppPSX->SetConfigProperty(_T("ButtonGoBack"), _T("EnterWtForPriceEmbedded"), UI::PROPERTYSTATE, (long)UI::Normal); 
  //-tar 330491
...
SMStateBase  *SMEnterWtForPriceEmbeddedBase::DMScale(void) 
{
  ...
  m_pAppPSX->SetConfigProperty(_T("ButtonGoBack"), _T("EnterWtForPriceEmbedded"), UI::PROPERTYSTATE, (long)UI::Disabled);  //tar 330491
  return TBEnterItem();
}
// + RFC 330050
