#pragma once
// $Header: /Integration_Customer/Meijer/CURRENT_DEV/Platform-Core-Patch/core/Include/KVParmList.h 3     10/29/08 4:31p Sm133076 $
/*
 * @(#)KeyValueParmList.h    $Revision: 3 $ $Date: 10/29/08 4:31p $
 *
 ...
 */
/*
* $Log: /Integration_Customer/Meijer/CURRENT_DEV/Platform-Core-Patch/core/Include/KVParmList.h $
 * 
 * 3     10/29/08 4:31p Sm133076
 * Patch G Migration
 * 
 * 1     6/23/08 4:54p Sa250050
 * FastLane 4.0 E5.3 Build 291 - Core Source
 * 
 * 18    4/28/08 11:40a Ah150000
 * TAR 375959
 * 
 * 17    4/24/08 5:05p Ah150000
 * Fix invalid pointer issue that caused dr. Watson (TAR 374839) .
 * 
