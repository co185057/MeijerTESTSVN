...
{				
	...
	/// </summary>
	internal class Biometric : IDisposable
	{
		/// <summary>
		/// The class constructor.
		/// </summary>		
		public Biometric(SharedPsx paramPsx)
		{
			myPsx = paramPsx;			
		}
		...
		//*******************************************************************************
		// Function:   	Close
		// Purpose:		Exit the fingerprint device
		// Parameters:	
		// Returns:		bool
		...
		// Purpose:		Connect to FP Device
		// Parameters:	
		// Returns:		bool
		// Calls:		FT_ConnectDevice - AuthenticationClientLibrary
		// Side Effects:	
		// Notes:		
		//*******************************************************************************
		...
		{			
			...
			if ( isDeviceReady() && isServerReady() )
			{				
				bReturn = FT_ConnectDevice();					
			}	
			
			CmDataCapture.Capture( CmDataCapture.MaskInfo, "Biometric::ConnectDevice() return: " + bReturn );
			return bReturn;
		}

		//*******************************************************************************
		// Function:   	DisconnectDevice
		// Purpose:		Disconnect to FP Device
		// Parameters:	
		// Returns:		bool
		// Calls:		FT_DisconnectDevice - AuthenticationClientLibrary
		// Side Effects:	
		// Notes:		
		//*******************************************************************************
		...
		{			
			...
			if ( isDeviceReady() && isServerReady() )
			{				
				bReturn = FT_DisconnectDevice();					
			}	
			
			CmDataCapture.Capture( CmDataCapture.MaskInfo, "Biometric::DisconnectDevice() return: " + bReturn );
			return bReturn;
		}
		...
		[DllImport(authenticationClientLibraryDll, CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, SetLastError = false)]
#endif
		private static extern bool FT_ConnectDevice();
		...
		[DllImport(authenticationClientLibraryDll, CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode, SetLastError = false)]
#endif
		private static extern bool FT_DisconnectDevice();
		...
		private string userID;    //i need this since ProcessSignOn() behaves differently from RapNet, coz of LP SignOnViaTB
