...
-------------------------------------------------------------------------------
$Archive: /Fastlane/4.2/Development/Core/Source/Include/ScotMsg.h $
$Revision: 5 $
$Date: 12/09/05 4:45p $
-------------------------------------------------------------------------------
*/
...
const enum GPEVT
{
  ...
  GP_RELOADOPTIONS,
  GP_CONNECT_FP_DEVICE,
  GP_DISCONNECT_FP_DEVICE,
  GP_ESCALATE_TO_RAP,
  GP_PRINT_RECEIPT_EXPIRE,
  GP_TCP_CONNECTED,
  GP_TCP_DISCONNECTED,
  GP_TCP_RECEIVED,
  GP_XMLMESSAGE,

  //Add any new GPMsg defines for Scotapp before this line
  GP_LASTBASEMSG = 1000    
  //Any numbers higher than GP_LASTBASEMSG might be used by SSF,  do not use.
};
