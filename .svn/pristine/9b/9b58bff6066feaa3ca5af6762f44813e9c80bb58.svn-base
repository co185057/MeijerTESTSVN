...
////////////////////////////////////////////////////////////////////////////////
void ConfigObject::CheckRange( int &lValue,
                        const int lMin,
                        const int lMax)
{
...
////////////////////////////////////////////////////////////////////////////////
CString ConfigObject::GetOptStr(   IScotWinApp* pApp,
                            LPCTSTR szSect,
                            LPCTSTR szKey,
                            LPCTSTR szDflt,
                            const bool fError)
...
////////////////////////////////////////////////////////////////////////////
int ConfigObject::GetOptInt(   IScotWinApp* pApp,
                        LPCTSTR szSect,
                        LPCTSTR szKey,
                        const int nDflt,
                        const bool fError)
...
// ---------------------------------------------------------------------------
 int ConfigObject::CleanOptIntArray(    
                                  LPCTSTR szSect,
...
// ---------------------------------------------------------------------------
int ConfigObject::GetOptIntArray(  IScotWinApp* pApp,
...
////////////////////////////////////////////////////////////////////////////
bool ConfigObject::GetOptFlg(  IScotWinApp* pApp,
                        LPCTSTR szSect,
                        LPCTSTR szKey,
                        const bool fDflt,
                        const bool fError, bool *bRead)
{
...
ConfigObject::ConfigObject()
    ...
    csOperationsHeadCashierContext(_T("SmAuthorization")),    //SR819
    ...
    fOperationsEnableMSRDegradedModeCashOnly(false),
    ...
    nOperationsOperatorLoginBarcodeHeight(4), //Tar 430804
    ...
    fStateDisableAudioInAttendantMode(true), // flag value T/F - Disable audio during attendant mode
    ...
    fStateAcceptWeightBtnEnable(false),//SR814.2
    fStateAcceptWeightBeepEnable(false),//SR814.2
    ...
    fStateTenderStartedMessage(false), // (*) SR797 ====================
    ...
    fStateContextSensitiveMenus(false),            //SR819
    fStateAssistMenuDuringFinalization(false),     //SR819
    csStateAssistMenuFinalizeContext(_T("")),      //SR819
    csStateAssistMenuFinalizeHeadCashier(_T("")),  //SR819
    csStateAssistMenuItemizeContext(_T("")),       //SR819
    csStateAssistMenuItemizeHeadCashier(_T("")),   //SR819
    ...
    nTimeOutPrintReceiptInThankYouScreenTimer(5000), //SR832, default timer value is 5secs.
    ...
    nTimeOutEnterWeightTimer(0), //SR814.2
    // +-SCOADK-5902
    nTimeOutCMMoneyInsertedTimer(0),

    // BeginCodeLocale
    //+SR834
    csLocaleStoreDescriptor(_T("")),
    csLocaleStoreName(_T("")),
    fLocaleShowStoreOnReport(false),
    //-SR834
    ...
    csLocaleDecimalSymbolForNumber(_T(".")),    // NUMBERFMT lpDecimalSep - SSCOB-13812
  ...
  fLocaleDisplayCashManagementAtRAP(false),      //SR969 - View CM at the RAP 
  ...
  fLocaleAltF4ExitAllowed(true), //SSCOP-1600
  fLocaleLeaveCashAcceptorsEnabledDuringTransaction(false), //SSCOADK-836
  fLocaleDisableCashAcceptorsDuringItemization(false),
   ...
   //+4.2 card dispenser
    ...
    fOperationsDisplayPickListSubCategoriesInTab(false),
    fOperationsHighlightFirstCategoryFromSearch(true),
...
// fiscal printer end 
    ...
    csOperationsReceiptBarcodeDataTextToBinaryDecoder(_T("None")),
    fOperationsEncodeDataAsPackedBCD(true),
    ...
    fOperationsCustomerBagAllowedInScanAndBag(false), //SR880
    ...
    fOperationsPersonalizationReceipt(false), //SR Personalization Digital Receipt
    ...
    //+SSCOADK-264
    nOperationsPicklistThreshold(90),
    nOperationsValidationThreshold(90),
    nTimeOutVVResponseWaitTimeout(2000),
    nOperationsPickListHashTableSize(1087),
    fOperationsPicklistAssistEnable(false),
    //-SSCOADK-264
    fOperationsPicklistSortedAlphabetical(true),
    fOperationsUsePicklistXMLImageName(false),
    fOperationsAllowPLAAutoAdvance(true),

    fOperationsTakeChangeBypassedIfNoBills(true),
    ...
    // (+) SR898 ====================
    fOperationsInvertLightStates(false),
    // (-) SR898 ====================
    fOperationsShowRapInfoWhenAbnormalBalance(false),   // Add Glory CM Support
    //+SR713
    ...
    //-SR713
    fOperationsAllowSMMKeyInCode(false), //SR821    
    ...
    fOperationsEnablePartialCut(false),
    fOperationsEnableSecurityInCMDataNeeded(false),//SR801,
    fOperationsOperatorNumericKeyPad(true),
    nOperationsOperatorIDMaxDigit(12),
    nOperationsOperatorPWMaxDigit(12),
    fOperationsEncodeOperatorIDPW(false),
    fOperationsSendPOSOperatorBarcode(false),
    csOperationsDefaultSendPOSOperatorPassword(_T("")),
    fOperationsAllowSaleofRestrictedItems(true), //sscoadk-321
	fOperationsAllowSaleofRestrictedItemsInAssist(true), //sscoadk-321
    nPrintObjectsSignatureWindowWidth(400), // SSCOADK-2522 
    nPrintObjectsSignatureWindowHeight(300), // SSCOADK-2522 
    fOperationsEnableTopazSignatureBoldness(false), 
    nPrintObjectsTopazSignatureBoldness(7)
    {
#ifndef _CPPUNIT
        LONG     lRC;
        HKEY     hKey;
      ...
      csPrimaryLanguageCode = csPrimaryCode;
        ...
        //+TAR 431887  Retrieve registry info for picklist configured resolution
        _TCHAR  szPicklistIConfiguredResolution[_MAX_PATH+1];
        dwDataSize =_MAX_PATH;
        csRegKeyName = _T("Configure");

        lRC = ::RegOpenKeyEx(HKEY_LOCAL_MACHINE, _T("SOFTWARE\\NCR\\SCOT\\Installation\\media"),
            0, KEY_QUERY_VALUE, &hKey);

        if (lRC == ERROR_SUCCESS)
        {
            lRC = RegQueryValueEx(hKey, csRegKeyName, NULL, NULL,
            (LPBYTE)szPicklistIConfiguredResolution, &dwDataSize);

            if (lRC == ERROR_SUCCESS)
                csPicklistImageConfiguredResolution = szPicklistIConfiguredResolution;
            else
                csPicklistImageConfiguredResolution = DEFAULTRESOLUTIONFORPICKLIST;
            ::RegCloseKey(hKey);
        }
        else
        {
        ...
        {
            DWORD dwDataSize = 4 ;
            lRC = RegQueryValueEx(hKey, _T("MaxLogSize"), NULL, NULL,
                (LPBYTE)&(to.m_nMaxLogSize), &dwDataSize);
        ...
        {
            DWORD dwDataSize = 4;
            lRC = ::RegQueryValueEx(hKey, _T("DisableBagScale"),NULL, NULL, (BYTE *)&nBagScaleDisabled, &dwDataSize);
            ::RegCloseKey(hKey);
...
// use the IScotWinApp profile functions to read configuration options
...
long ConfigObject::Initialize(const int nTerminal)
{
    ...
    //Reset these values
     ...
     m_iNumberOfLanguagesSupported = 1;     // TAR 446397

     //SSCOADK-2504 Load Barcode Print Widths
     caBarcodePrintWidth.RemoveAll(); 
        ...
        else
        {
            ...
            if (lRC == ERROR_SUCCESS)
            {
                ...
                if (!co.csCurrencyBitmap.GetLength())
                {
                    ...
                    (co.csCurrencyBitmap != _T("DKK")) )      // TAR 429096 - Invalid country code
                {
...
//NN RFC 210177
 ...
 //NN RFC 210777 end
    ...
    CheckRange(nTimeOutTakeReceipt,0, 180);
    ...
    CheckRange(nTimeOutPrintReceiptInThankYouScreenTimer,0,180000); //SR832
    ...
    CheckRange(nTimeOutThankYouTimerNoBagScale,0,180);
	...
	//+SSCOADK-264
	 CheckRange(nOperationsPicklistThreshold,0,100);
     CheckRange(nOperationsValidationThreshold,0,100);
	 CheckRange(nTimeOutVVResponseWaitTimeout,2000,5000);
	//-SSCOADK-264
    // +-SCOADK-5902
    CheckRange(nTimeOutCMMoneyInsertedTimer,0,15000);

    //+SR814.2
    if(0 != nTimeOutEnterWeightTimer)
    {
       CheckRange(nTimeOutEnterWeightTimer,1000,180000);
    }
    CheckRange(nTimeOutRemoveItemFromProduceScaleAudio, 0, 180);
    //-SR814.2
    ...
    trace(L0,_T("Common TimeOut TakeReceipt %d"), nTimeOutTakeReceipt);
    ...
    trace(L0,_T("Common TimeOut Print Receipt in Thank You Screen %d"), nTimeOutPrintReceiptInThankYouScreenTimer); //SR832
    ...
    trace(L0,_T("Common TimeOut Thank You Timer Belt %d"), nTimeOutThankYouTimerBelt);
     trace(L0,_T("Common TimeOut Thank You Timer No Bagscale %d"), nTimeOutThankYouTimerNoBagScale);
    ...
    trace(L0,_T("Common TimeOut Remove Item From Produce Scale Audio %d"), nTimeOutRemoveItemFromProduceScaleAudio);
    
    trace(L0,_T("Common SayPrices = %d,  SayPhrases = %d,  AllowTBAudioControl = %d, SayPricesAttendantMode = %d, DisableAudioInAttendantMode=%d"),
    fStateSayPrices,
    fStateSayPhrases,
    fStateAllowTBAudioControl, 
    !fStateSayPricesDisableInAttendantMode,
    fStateDisableAudioInAttendantMode);
	...
	trace(L0, _T("Base64 Decoder? %s"),csOperationsReceiptBarcodeDataTextToBinaryDecoder);
	trace(L0, _T("Encode data as Packed Binary Coded Decimal? %d"),fOperationsEncodeDataAsPackedBCD);
    ...
    trace(L0,_T("AcceptWeightBtnEnable = %d"), fStateAcceptWeightBtnEnable);//SR814.2 
    trace(L0,_T("AcceptWeightBeepEnable = %d"), fStateAcceptWeightBeepEnable);//SR814.2
    trace(L0,_T("Common TimeOut EnterWeightTimer %d"), nTimeOutEnterWeightTimer); //SR814.2
    trace(L0,_T("Send Tender Selected Message = %d"), fStateTenderStartedMessage); // (*) SR797 ====================
    trace(L0,_T("ContextSensitiveMenus = %d"), fStateContextSensitiveMenus);                  //SR819
    trace(L0,_T("AssistMenuDuringFinalization = %d"), fStateAssistMenuDuringFinalization);    //SR819
    trace(L0,_T("AssistMenuFinalizeContext = %s"), csStateAssistMenuFinalizeContext);         //SR819
    trace(L0,_T("AssistMenuFinalizeHeadCashier = %s"), csStateAssistMenuFinalizeHeadCashier); //SR819
    trace(L0,_T("AssistMenuItemizeContext = %s"), csStateAssistMenuItemizeContext);           //SR819
    trace(L0,_T("AssistMenuItemizeHeadCashier = %s"), csStateAssistMenuItemizeHeadCashier);   //SR819 
	// +-SSCOADK-6179
    trace(L0,_T("ShowRapInfoWhenAbnormalBalance = %d"), fOperationsShowRapInfoWhenAbnormalBalance); // Add Glory CM Support
    ...
    // TakeReceipt          display TakeReceipt screen after printing receipt
    ...
    trace(L0,_T("DisplayCashManagementAtRAP %d"), fLocaleDisplayCashManagementAtRAP );  //SR969 - View CM at the RAP
...
trace(L0,_T("fLocaleCashManagementAPPTrackCashCount %d"), fLocaleCashManagementAPPTrackCashCount);  
    ...
    trace(L0, _T("Allow Alt-F4 to exit scotapp.exe? %d"),fLocaleAltF4ExitAllowed);  //SSCOP-1600
	trace(L0,_T("fLocaleLeaveCashAcceptorsEnabledDuringTransaction %d"), fLocaleLeaveCashAcceptorsEnabledDuringTransaction);  //SSCOADK-836
    trace(L0,_T("fLocaleDisableCashAcceptorsDuringItemization %d"), fLocaleDisableCashAcceptorsDuringItemization);
...
*/
   ...
   CheckRange(nOperationsRemoteAssistModeToggleDisplay,0,3);
    ...
    trace(L0,_T("Final TimeOut TakeReceipt %d"), nTimeOutTakeReceipt);
    ...
    trace(L0,_T("Final TimeOut Thank You Timer No BagScale %d"), nTimeOutThankYouTimerNoBagScale);
    ...
    trace(L0,_T("Final TimeOut Remove Item From Produce Scale Audio %d"), nTimeOutRemoveItemFromProduceScaleAudio);
	...
	//+SSCOADK-264
	trace(L0, _T("Picklist Threshold: %d"), nOperationsPicklistThreshold);
    trace(L0, _T("Validation Threshold: %d"), nOperationsValidationThreshold);
    trace(L0, _T("Is Picklist Assist Enable: %d"), fOperationsPicklistAssistEnable);
    trace(L0, _T("PickList HashTable size: %d"), nOperationsPickListHashTableSize);
    trace(L0, _T("Pipeserver Response Period Timeout: %d"), nTimeOutVVResponseWaitTimeout);
	//-SSCOADK-264
    trace(L0, _T("Is Picklist sorted alphabetical: %d"), fOperationsPicklistSortedAlphabetical);
    trace(L0, _T("Allow PLA Auto Advance? %d"), fOperationsAllowPLAAutoAdvance);

    trace(L0, _T("By passed TakeChange Screen if No Bills change: %d"), fOperationsTakeChangeBypassedIfNoBills);
    ...
    trace(L0, _T("Enable MSR in Degraded Mode Cash Only? %d"), fOperationsEnableMSRDegradedModeCashOnly);
    ...
    trace(L0, _T("The Operator Login Barcode Height  is: %d") , nOperationsOperatorLoginBarcodeHeight);
    ...
    trace(L0, _T("Enable Security Check In Data Needed Screens %d"),fOperationsEnableSecurityInCMDataNeeded);//SR801
    ...
    trace(L0, _T("Display Pick List SubCategories In Tab? %d"), fOperationsDisplayPickListSubCategoriesInTab);
    trace(L0, _T("Highlight First Category From Search? %d"), fOperationsHighlightFirstCategoryFromSearch);
...
// fiscal printer end
   trace(L0, _T("Remote Assist Mode Toggle Display Option %d"), nOperationsRemoteAssistModeToggleDisplay);
    ...
    trace(L0,_T("Final SayPrices = %d,  SayPhrases = %d,  AllowTBAudioControl = %d, SayPricesInAttendantMode = %d, DisableAudioInAttendantMode = %d"), 
                fStateSayPrices,
                fStateSayPhrases,
                fStateAllowTBAudioControl, 
                !fStateSayPricesDisableInAttendantMode,
    ...
    trace(L0,_T("CustomerBagAllowedInScanAndBag = %d"),fOperationsCustomerBagAllowedInScanAndBag);//SR880
    trace(L0,_T("AllowSMMKeyInCode = %d"),fOperationsAllowSMMKeyInCode);    //SR821
    trace(L0,_T("IncludeCouponsInItemCount = %d"),fOperationsIncludeCouponsInItemCount);//RFC 371075
    trace(L0,_T("OperatorNumericKeyPad = %d"), fOperationsOperatorNumericKeyPad);
    trace(L0,_T("EncodeOperatorIDPW = %d"), fOperationsEncodeOperatorIDPW);
    trace(L0,_T("AllowSaleofRestrictedItems = %d"), fOperationsAllowSaleofRestrictedItems);
    trace(L0,_T("AllowSaleofRestrictedItemsInAssist = %d"), fOperationsAllowSaleofRestrictedItemsInAssist);


    if (nOperationsOperatorIDMaxDigit == 0)
    {
        trace(L0,_T("OperatorIDMaxDigit = 0. Setting it to default PSProcedures EchoInput MaxLimit of 72"));
        nOperationsOperatorIDMaxDigit = 72;
    }
    trace(L0,_T("OperatorIDMaxDigit = %d"), nOperationsOperatorIDMaxDigit);
    if (nOperationsOperatorPWMaxDigit == 0)
    {
        trace(L0,_T("OperatorPWMaxDigit = 0. Setting it to default PSProcedures EchoInput MaxLimit of 72"));
        nOperationsOperatorPWMaxDigit = 72;
    }
    trace(L0,_T("OperatorPWMaxDigit = %d"), nOperationsOperatorPWMaxDigit);
    trace(L0,_T("SendPOSOperatorBarcode = %d"), fOperationsSendPOSOperatorBarcode);
    trace(L0,_T("DefaultSendPOSOperatorPassword = %s"), csOperationsDefaultSendPOSOperatorPassword);
    ...
    trace(L0, _T("Default Image file path = %s"), csDataDefaultImagePath);
    ...
    CheckRange(nPrintObjectsSignatureWindowWidth,0,400);    // SSCOADK-2522
    CheckRange(nPrintObjectsSignatureWindowHeight,0,300);   // SSCOADK-2522
    CheckRange(nPrintObjectsTopazSignatureBoldness,0,255);
	...
	trace(L0,_T("HWType = %s"),csHWType); //SSCOADK-3006
    trace(L0,_T("HWSpec = %s"),csHWSpec); //SSCOADK-3006
    trace(L0,_T("HWConfigure = %s"),csHWConfigure); //SSCOADK-3006
    ...
    if (lRC == ERROR_SUCCESS)
    { 
        RegSetValueEx(hKey, _T("MaxLogSize"), 0L, REG_DWORD, (LPBYTE)&nTracingMaxLogSize, sizeof(DWORD));        
        ::RegCloseKey(hKey);
    }
    // -SSCOB-382 Migration Fix
    ...
    if (!fLocaleCurrencySettingNotFromRegionalSetting)
    {
		...
		// SSCOB-13812: We also need to get the decimal separator from 'Numbers', not just from 'Currency'
        LCType = LOCALE_SDECIMAL;						  	    // Character(s) used as the decimal separator for 'numbers'
		GetLocaleInfo(	Locale,									// locale identifier
						LCType,									// type of information
						lpLCData.GetBuffer(cchData),			// address of buffer for information
						cchData);								// size of buffer
		csLocaleDecimalSymbolForNumber = lpLCData.GetBuffer(cchData);
		lpLCData.ReleaseBuffer(0);
    }
   ...
   trace(L0,_T("CM, RewardInfo        = %d"), fCMRewardInfo);
    ...
    // SSCOADK-2522: Need to handle printing signature on 80mm (default) or 58mm receipt paper
    trace(L0,_T("PrintObjects, SignatureWindowWidth=%d"),nPrintObjectsSignatureWindowWidth);
    trace(L0,_T("PrintObjects, SignatureWindowHeight=%d"),nPrintObjectsSignatureWindowHeight);
    trace(L0,_T("PrintObjects, TopazSignatureBoldness=%d"),nPrintObjectsTopazSignatureBoldness);
#endif //_CPPUNIT
    return 0;
}

void ConfigObject::LoadLanguageOptions(IScotWinApp *pApp)
{
   ...
   if(fStateDualLanguage)
   {
      ...
      int nStrIndex;
#endif
      int nLanguageMax=SCOT_LANGUAGE_MAX;
...
#endif //_CPPUNIT
      ps.LoadLanguageUIStrings(SCOT_LANGUAGE_PRIMARY);
...
void ConfigObject::LoadCashValueLists(CString csValueList, CString csLowList, CString csHighList, CString csCashCapacity, CString csCashRemoveAmount)
{
  ...
  int nStrAmount;
    ...
    trace(L6, _T("+ConfigObject::LoadCashValueLists"));
    trace(L6, _T("ConfigObject::LoadCashValueLists (csValueList: '%s')"), csValueList);
    trace(L6, _T("ConfigObject::LoadCashValueLists (csLowList: '%s')"), csLowList);
    trace(L6, _T("ConfigObject::LoadCashValueLists (csHighList: '%s')"), csHighList);
    trace(L6, _T("ConfigObject::LoadCashValueLists (csCashCapacity: '%s')"), csCashCapacity);
    trace(L6, _T("ConfigObject::LoadCashValueLists (csCashRemoveAmount: '%s')"), csCashRemoveAmount);

  // Get the values from the string as numbers.
  while (!csValueList.IsEmpty())
  {
  ...
  while(!csCashRemoveAmount.IsEmpty())
  {
...
long ConfigObject::InitTenderOptions(CString& csFileName, SCOT_LANGUAGE_TYPE language_used)
{
    ...
    int i;
#ifndef _CPPUNIT
    IScotWinApp* pApp = new CScotWinApp();
#else
    IScotWinApp* pApp = new CFakeScotWinApp();
#endif //_CPPUNIT
//  CString csAppProfile = pApp->m_pszProfileName;
    LPCTSTR pszAppProfile = pApp->GetProfileName();
    ...
    for (int iReset = 0; iReset < MAXBUTTONNUM; iReset++)
    {
        ...
        TenderList[language_used][iReset].nPrintReceiptTrxOverAmount = 0; //SR832 default value is 0, means that we print any receipt regardless of total transaction amount.
        ...
        TenderList[language_used][iReset].csAnimation = _T("");
    }
    ...
    for (i = 0;  i < MAXBUTTONNUM; i++)
    {
        ...
        TenderList[language_used][i].nPrintReceiptTrxOverAmount = GetOptInt(pApp, csSection, _T("PrintReceiptTrxOverAmount"), TenderList[language_used][i].nPrintReceiptTrxOverAmount, fErrorLog); //SR832, get the PrintReceiptTrxOverAmount value under each tender type in SCOTTEND file 
        TenderList[language_used][i].csAnimation = GetOptStr(pApp, csSection, _T("Animation"),TenderList[language_used][i].csAnimation, fErrorLog);
    }
#endif //_CPPUNIT
    //pApp->m_pszProfileName =    pszAppProfile;
    pApp->SetProfileName(pszAppProfile);
...
//  CString csAppProfile = pApp->m_pszProfileName;
    ...
    // TakeCash            wait to take back paper money
    // TakeCoins              wait to take back coin change
    // TakeReceipt         display TakeReceipt after printing receipt
    // ItemTransactionResult  wait for supermarket item processing
    // ContinueTransaction  wait at continue transaction screen
    // Help                wait at help screen
    // Signon                wait to sign on from Attract
	...
	//+SSCOADK-264
	_GET_INT(Operations, PicklistThreshold);
    _GET_INT(Operations, ValidationThreshold);
    _GET_FLG(Operations, PicklistAssistEnable);
    _GET_INT(Operations, PickListHashTableSize);
    _GET_INT(TimeOut, VVResponseWaitTimeout);
	//-SSCOADK-264
    _GET_FLG(Operations, AllowPLAAutoAdvance);

    _GET_FLG(Operations,PicklistSortedAlphabetical);
    _GET_FLG(Operations, UsePicklistXMLImageName);

    _GET_FLG(Operations,TakeChangeBypassedIfNoBills);
    ...
    _GET_FLG(Operations,EnableMSRDegradedModeCashOnly);
    ...
    _GET_FLG(Operations, PersonalizationReceipt); //SR Personalization Digital Receipt
    ...
    // _GET_INT(Operations, PrinterCutPercentage);     // max allowed manual coupon value
    _GET_FLG(Operations, EnablePartialCut);  // RFC 368220 - Need option to disable CutReceipt() added to Transaction Receipt ac185097
...
// fiscal printer end
    ...
    _GET_FLG(Operations,EnableSecurityInCMDataNeeded);//SR801
    _GET_FLG(Operations,ShowRapInfoWhenAbnormalBalance);    // Add Glory CM Support
    _GET_FLG(Operations,OperatorNumericKeyPad);
    _GET_INT(Operations,OperatorIDMaxDigit);
    _GET_INT(Operations,OperatorPWMaxDigit);
    _GET_FLG(Operations,EncodeOperatorIDPW);
    _GET_FLG(Operations,SendPOSOperatorBarcode);
    _GET_STR(Operations,DefaultSendPOSOperatorPassword);
	_GET_FLG(Operations,AllowSaleofRestrictedItems); //sscoadk-321
	_GET_FLG(Operations,AllowSaleofRestrictedItemsInAssist); //sscoadk-321
    ...
    _GET_FLG(Operations,DisplayPickListSubCategoriesInTab);
    _GET_FLG(Operations,HighlightFirstCategoryFromSearch);
    ...
    _GET_STR(Operations, ReceiptBarcodeDataTextToBinaryDecoder);
   	_GET_FLG(Operations,  EncodeDataAsPackedBCD);  
   ...
   _GET_FLG(Operations, DisplayGiftCardBalance);
    ...
    _GET_FLG(Operations, CustomerBagAllowedInScanAndBag);//SR880
    ...
    _GET_FLG(State,DisableAudioInAttendantMode); // flag value Y/N 
   ...
   LoadLanguageOptions(pApp);
    ...
    _GET_FLG(State, ContextSensitiveMenus);         //SR819
    _GET_FLG(State, AssistMenuDuringFinalization);  //SR819
    _GET_STR(State, AssistMenuFinalizeContext);     //SR819
    _GET_STR(State, AssistMenuFinalizeHeadCashier); //SR819 
    _GET_STR(State, AssistMenuItemizeContext);      //SR819
    _GET_STR(State, AssistMenuItemizeHeadCashier);  //SR819

    _GET_FLG(State, SecurityDisableAllowed); // SR683
    _GET_FLG(State, SecurityDisableNoReset); // SR683

    _GET_FLG(State, AcceptWeightBtnEnable);  //SR814.2 
    _GET_FLG(State, AcceptWeightBeepEnable); //SR814.2
    
    _GET_FLG(State, TenderStartedMessage);   // (*) SR797 ====================
    ...
    _GET_INT(TimeOut,PrintReceiptInThankYouScreenTimer); //SR832
    ...
    _GET_INT(TimeOut,ThankYouTimerNoBagScale);
    ...
    _GET_INT(TimeOut,EnterWeightTimer); //SR814.2
    _GET_INT(TimeOut,RemoveItemFromProduceScaleAudio);
    // +-SCOADK-5902
    _GET_INT(TimeOut,CMMoneyInsertedTimer);
    ...
    //+SR834 - load options to show store name and number on CM Receipts header
    _GET_STR(Locale, StoreName);
    _GET_STR(Locale, StoreDescriptor);
    _GET_FLG(Locale, ShowStoreOnReport);
    //-SR834
  ...
  _GET_FLG(Locale, DisplayCashManagementAtRAP);  //SR969 - View CM at the RAP
  ...
  //-dp185016
    //SSCOP-1600
    _GET_FLG(Locale,  AltF4ExitAllowed);  // Allow Alt-F4 to exit scotapp.exe? 
   	_GET_FLG(Locale, LeaveCashAcceptorsEnabledDuringTransaction); //SSCOADK-836
    _GET_FLG(Locale, DisableCashAcceptorsDuringItemization);
...
// END NEW UI
    _GET_STR(Data, DefaultImagePath);


    _GET_STR(PrintObjects, ChitBmp1);
    _GET_STR(PrintObjects, ChitBmp2);
    _GET_INT(PrintObjects, SignatureWindowWidth);  // SSCOADK-2522
    _GET_INT(PrintObjects, SignatureWindowHeight); // SSCOADK-2522
    _GET_INT(PrintObjects, TopazSignatureBoldness);
    ...
    _GET_FLG(Operations,EnableTopazSignatureBoldness);
    //+SR719
    _GET_FLG(Operations, VolumeControlMuteBypass);
    //-SR719
    
    // (+) SR898 ====================
    _GET_FLG(Operations, InvertLightStates);
    // (-) SR898 ====================
    ...
    //-RFC 368222 
    _GET_FLG(Operations, AllowSMMKeyInCode);    //SR821
    _GET_STR(Operations, HeadCashierContext);     
    trace(L0, _T("HeadCashierContext = %s"), csOperationsHeadCashierContext);

    GetHWConfig();  //SSCOADK-3006  
    //++SSCOADK-2504 Load Barcode Print Widths
    TCHAR *szData;
    int size = GetSizeAndDataInSection(_T("BarcodePrintWidths"),csFileName,szData);
    if(size > 0)
    {
        TCHAR *ptr=szData;
        do { //loop to get all entries and values in the BarcodePrintWidths section
            CString bcType(ptr),csWidth(_T("0"));
            int iFieldSize=64;
            TCHAR *szField = new TCHAR[iFieldSize];
            size = GetPrivateProfileString(_T("BarcodePrintWidths"),bcType,_T("0"),szField,iFieldSize,csFileName);
            if(size>0)
            {
                csWidth=szField;
            }
            //put bcType and csWidth into the barcode print widths array
            SBmpPrintWidths newData;
            newData.nBarcodeType=_ttoi(bcType);
            newData.nPrintWidth=_ttoi(csWidth);
            bool bFound=false;
            for(int i=0;i<caBarcodePrintWidth.GetSize();i++)//check if type already in the array
            {
                SBmpPrintWidths &ptr = caBarcodePrintWidth.ElementAt(i);
                if(newData.nBarcodeType == ptr.nBarcodeType) //type is already in the array, just change the width
                {
                    bFound=true;
                    ptr.nPrintWidth=newData.nPrintWidth;
                    trace(L0, _T("%s: BarcodePrintWidths Type=%d PrintWidth=%d Changed"),csFileName,newData.nBarcodeType,newData.nPrintWidth);
                    break;
                }
            }
            if(!bFound)//if type not already in the array, add type and width
            {
                caBarcodePrintWidth.Add(newData);
                trace(L0, _T("%s: BarcodePrintWidths Type=%d PrintWidth=%d Added"),csFileName,newData.nBarcodeType,newData.nPrintWidth);
            }
            //setup for next field
            delete [] szField;
            ptr += bcType.GetLength() + 1;
        } while (*ptr!=NULL);
        delete [] szData;
    }
    //--SSCOADK-2504 Load Barcode Print Widths
...
//helper method introduced with SSCOADK-2504
int ConfigObject::GetSizeAndDataInSection(LPCTSTR szSection, LPCTSTR szFileName, LPTSTR &szData)
{
    int size;

    for (int maxsize=64;true;maxsize*=2)//try to get the right size buffer in 64 byte increments
    {
        szData = new TCHAR[maxsize];
        size = GetPrivateProfileString(szSection,0,_T(""),szData,maxsize,szFileName);
        if(size == 0) //nothing defined in this section in this file
        {
            trace(L0, _T("ConfigObject::GetSizeAndDataInSection() No data in section:%s file:%s"),szSection,szFileName);
            delete [] szData;
            szData=NULL;
            break;
        }
        if(size < maxsize -2) //check that buffer was big enough for all the data in the section, if not, loop to get bigger buffer and try again
        {
            break;
        }
        delete [] szData;
    ...
    return size;//and szData pointer has the data 
}
...
void ConfigObject::InitCustomerBagAllowed(bool bIsTAB)  
{
  ...
  if(bIsTAB)
  {
      if(fOperationsCustomerBagAllowed){
          ScotError(INFO, SM_CAT_CONFIGURATION, BAGBOX_CONFIG_ERROR);             
          fOperationsCustomerBagAllowed = false;
      }

      if(fOperationsCustomerBagAllowedInScanAndBag){
          ScotError(INFO, SM_CAT_CONFIGURATION, OWNBAG_CONFIG_ERROR);
          fOperationsCustomerBagAllowedInScanAndBag = false;
      }
...
/**
 * One of the requirement for PickList Assist is to force
 * Multipick to 'N' when PickListAssist is enable.
 */
void ConfigObject::InitPickListAssistOptions()  
{
  if(fOperationsPicklistAssistEnable)
  {
      if(fOperationsAllowMultiPick)
      {
          trace(L6, _T("Forcing AllowMultiPick to false when PicklistAssistEnable is true"));
    #ifndef _CPPUNIT
          ScotError(INFO, SM_CAT_CONFIGURATION, MULTIPICK_CONFIG_ERROR); 
    #endif //_CPPUNIT
          fOperationsAllowMultiPick = false;
      }
  }
  ...
  {
      fOperationsAllowPLAAutoAdvance = false;
  }

}


bool ConfigObject::GetfStateDualLanguage(void) const
{
    return fStateDualLanguage;
}

bool ConfigObject::GetfOperationsInvertLightStates(void) const
{
    return fOperationsInvertLightStates;
}

bool ConfigObject::GetfAutoRunOn(void) const
{
    return fAutoRunOn;
}

void ConfigObject::SetfAutoRunOn(bool bAutorun)
{
    fAutoRunOn = bAutorun;
}

bool ConfigObject::GetfAutoRunAssistModeOn(void) const
{
    return fAutoRunAssistModeOn;
}

void ConfigObject::SetfAutoRunAssistModeOn(bool bAutoRunAssistModeOn)
{
    fAutoRunAssistModeOn = bAutoRunAssistModeOn;
}

bool ConfigObject::GetfStateSingleLanguageButtonAtAttract(void) const
{
    return fStateSingleLanguageButtonAtAttract;
}

SLanguageInfo ConfigObject::Getlanguage(int index) const
{
...
bool ConfigObject::IsPicklistAssistEnable() const 
{
    return fOperationsPicklistAssistEnable; 
}

bool ConfigObject::GetAllowPLAAutoAdvance() const 
{
    return fOperationsAllowPLAAutoAdvance; 
}

int ConfigObject::GetPicklistThreshold() const 
{ 
    return nOperationsPicklistThreshold; 
}

int ConfigObject::GetValidationThreshold() const 
{ 
    return nOperationsValidationThreshold; 
}

int ConfigObject::GetPickListHashTableSize() const 
{ 
    return nOperationsPickListHashTableSize; 
}
  
int ConfigObject::GetVVResponseWaitTimeout() const 
{ 
    return nTimeOutVVResponseWaitTimeout; 
}
//-SSCOADK-264

bool ConfigObject::GetfOperationsPicklistSortedAlphabetical(void) const
{
    return fOperationsPicklistSortedAlphabetical;
}

bool ConfigObject::GetfOperationsUsePicklistXMLImageName(void) const
{
    return fOperationsUsePicklistXMLImageName;
}

bool ConfigObject::GetfOperationsTakeChangeBypassedIfNoBills(void) const
{
    return fOperationsTakeChangeBypassedIfNoBills;
}

bool ConfigObject::GetfOperationsAllowMultiPick() const 
{ 
    return fOperationsAllowMultiPick;
}

int ConfigObject::GetNumberOfLanguagesSupported() const 
{ 
    return m_iNumberOfLanguagesSupported;
}

bool ConfigObject::GetfOperationsAllowFuzzySearch() const 
{ 
    return fOperationsAllowFuzzySearch;
}

CString ConfigObject::GetcsPicklistImagePath() const 
{ 
    return csPicklistImagePath;
}

bool ConfigObject::GetfOperationsDisplayPickListItemCode() const 
{ 
    return fOperationsDisplayPickListItemCode;
}

bool ConfigObject::GetfOperationsSuppressAudioInMismatch() const 
{ 
    return fOperationsSuppressAudioInMismatch;
}

bool ConfigObject::GetfOperationsAllowContainerBtnForMismatching() const 
{ 
    return fOperationsAllowContainerBtnForMismatching;
}

CString ConfigObject::GetcsDataEntryINIFile() const 
{ 
    return csDataEntryINIFile;
}

bool ConfigObject::GetfOperationsAllowContainerBtn() const 
{ 
    return fOperationsAllowContainerBtn;
}

bool ConfigObject::GetfOperationsDisableUnexpIncContainerBtnAftFirstItem() const 
{ 
    return fOperationsDisableUnexpIncContainerBtnAftFirstItem;
}

bool ConfigObject::GetfOperationsSuppressAudioInUnexpectedIncrease() const 
{ 
    return fOperationsSuppressAudioInUnexpectedIncrease;
}

bool ConfigObject::GetfOperationsAllowContainerBtnInFinalization() const 
{ 
    return fOperationsAllowContainerBtnInFinalization;
}

bool ConfigObject::GetfStateSecurityDisableAllowed() const 
{ 
    return fStateSecurityDisableAllowed;
}

bool ConfigObject::GetfOperationsEnableUSSF() const 
{ 
    return fOperationsEnableUSSF;
}

CString ConfigObject::GetcsPrimaryLanguageCode()
{ 
    return csPrimaryLanguageCode;;
}

bool ConfigObject::GetbOperationsUseFingerPrintDevice() const 
{ 
    return m_bOperationsUseFingerPrintDevice;
}

bool ConfigObject::GetfUserExitAllEnabled() const 
{ 
    return fUserExitAllEnabled;
}

bool ConfigObject::GetfUserExit00Enabled() const 
{ 
    return fUserExit00Enabled;
}

bool ConfigObject::GetfOperationsPrintVersion() const 
{ 
    return fOperationsPrintVersion;
}

bool ConfigObject::GetfStateAttndModeAllowed() const 
{ 
    return fStateAttndModeAllowed;
}

bool ConfigObject::GetfOperationsScaleMetric() const 
{ 
    return fOperationsScaleMetric;
}

bool ConfigObject::GetfOperationsShowItemRemovedButtonOnRemoveItemViolationScreen() const 
{ 
    return fOperationsShowItemRemovedButtonOnRemoveItemViolationScreen;
}

CString ConfigObject::GetCMCustomerMessage()
{ 
    return csCMCustomerMessage;
}

void ConfigObject::SetCMCustomerMessage(CString  csCustomerMessage)
{ 
    csCMCustomerMessage = csCustomerMessage;
}

bool ConfigObject::GetfOperationsAutoVoidUnderageRestrict() const 
{ 
    return fOperationsAutoVoidUnderageRestrict;
}

int ConfigObject::GetnOperationsOperatorIDMaxDigit() const 
{ 
    return nOperationsOperatorIDMaxDigit;
}

bool ConfigObject::GetfOperationsOperatorNumericKeyPad() const 
{ 
    return fOperationsOperatorNumericKeyPad;
}

bool ConfigObject::GetfOperationsEncodeOperatorIDPW(void) const 
{ 
    return fOperationsEncodeOperatorIDPW;
}

int ConfigObject::GetnOperationsOperatorPWMaxDigit() const 
{ 
    return nOperationsOperatorPWMaxDigit;
}

TenderButton ConfigObject::GetTenderButton(SCOT_LANGUAGE_TYPE language, int nButtonIndex) const
{
    return TenderList[language][nButtonIndex];
}

bool ConfigObject::GetfCMRewardInfo() const 
{ 
    return fCMRewardInfo;
}

CString ConfigObject::GetcsTemplateAssistMode() const 
{ 
    return csTemplateAssistMode;
}

CString ConfigObject::GetcsDataXMLFile() const 
{ 
    return csDataXMLFile;
}

int ConfigObject::GetnCMCustomerMessage() const 
{ 
    return nCMCustomerMessage;
}

bool ConfigObject::GetfTenderShowUseCoupons() const 
{ 
    return fTenderShowUseCoupons;
}

bool ConfigObject::GetfTenderEBTFSAllowed() const 
{ 
    return fTenderEBTFSAllowed;
}

bool ConfigObject::GetfTenderOtherPayment() const 
{ 
    return fTenderOtherPayment;
}

bool ConfigObject::GetfTenderCashAllowed() const 
{ 
    return fTenderCashAllowed;
}

bool ConfigObject::GetfTenderCreditAllowed() const 
{ 
    return fTenderCreditAllowed;
}

bool ConfigObject::GetfTenderDebitAllowed() const 
{ 
    return fTenderDebitAllowed;
}

bool ConfigObject::GetfTenderCreditNeedsPIN() const 
{ 
    return fTenderCreditNeedsPIN;
}

bool ConfigObject::GetfTenderDebitNeedsPIN() const 
{ 
    return fTenderDebitNeedsPIN;
}

bool ConfigObject::GetfTenderCreditCashBack() const 
{ 
    return fTenderCreditCashBack;
}

bool ConfigObject::GetfTenderDebitCashBack() const 
{ 
    return fTenderDebitCashBack;
}

bool ConfigObject::GetfTenderEBTFSNeedsPIN() const 
{ 
    return fTenderEBTFSNeedsPIN;
}

bool ConfigObject::GetfTenderEBTCBAllowed() const 
{ 
    return fTenderEBTCBAllowed;
}

bool ConfigObject::GetfTenderEBTCBNeedsPIN() const 
{ 
    return fTenderEBTCBNeedsPIN;
}

bool ConfigObject::GetfTenderEBTCBCashBack() const 
{ 
    return fTenderEBTCBCashBack;
}

bool ConfigObject::GetfTenderAllowCancelWithPartialEBTTender() const 
{ 
    return fTenderAllowCancelWithPartialEBTTender;
}

bool ConfigObject::GetfTenderSubmitFSTtotalIfMorethanTrxTotal() const 
{ 
    return fTenderSubmitFSTtotalIfMorethanTrxTotal;
}

bool ConfigObject::GetfTenderIsMotorizedMSR() const 
{ 
    return fTenderIsMotorizedMSR;
}

bool ConfigObject::GetfTenderDispenseChangeAtLaneForRemoteTendering() const 
{ 
    return fTenderDispenseChangeAtLaneForRemoteTendering;
}

int ConfigObject::GetnOperationsGiftCardRedemption() const 
{ 
    return nOperationsGiftCardRedemption;
}

CString ConfigObject::GetcsDataTareFile() const 
{ 
    return csDataTareFile;
}

int ConfigObject::GetnOperationsTareContainer1() const 
{ 
    return nOperationsTareContainer1;
}

int ConfigObject::GetnOperationsTareContainer2() const 
{ 
    return nOperationsTareContainer2;
}

bool ConfigObject::GetfStateLiveVideo() const 
{ 
    return fStateLiveVideo;
}

CString ConfigObject::GetcsOperationsOperatorBarcodeMask() const 
{ 
    return csOperationsOperatorBarcodeMask;
}

bool ConfigObject::GetfOperationsSendPOSOperatorBarcode() const
{
    return fOperationsSendPOSOperatorBarcode;
}

int ConfigObject::GetnOperationsOperatorLoginBarcodeType() const
{
    return nOperationsOperatorLoginBarcodeType;
}

bool ConfigObject::GetfOperationsAllowLeadingZerosInCode128LoginBarCode() const
{
    return fOperationsAllowLeadingZerosInCode128LoginBarCode;
}

CString ConfigObject::GetcsOperationsDefaultSendPOSOperatorPassword() const
{
    return csOperationsDefaultSendPOSOperatorPassword;
}

int ConfigObject::GetnTracingCurrentLevel() const
{
    return nTracingCurrentLevel;
}

bool ConfigObject::GetfOperationsAllowPickListSearchButton() const
{
    return fOperationsAllowPickListSearchButton;
}
bool ConfigObject::GetfOperationsAllowSaleofRestrictedItems() const 
{ 
    return fOperationsAllowSaleofRestrictedItems;
}

bool ConfigObject::GetfOperationsAllowSaleofRestrictedItemsInAssist() const 
{ 
    return fOperationsAllowSaleofRestrictedItemsInAssist;
}

bool ConfigObject::GetfAutoRunBypassBagging() const
{
    return fAutoRunBypassBagging;
}

bool ConfigObject::GetfOperationsAllowSkipBaggingBtn() const
{
    return fOperationsAllowSkipBaggingBtn;
}

bool ConfigObject::GetfOperationsInterventionAtStartOfTrainingModeTransaction() const
{
    return fOperationsInterventionAtStartOfTrainingModeTransaction;
}

bool ConfigObject::GetfOperationsHopperSubstitutionIntervention() const
{
    return fOperationsHopperSubstitutionIntervention;
}

int ConfigObject::GetnOperationsAllowDispenseInTrainingMode() const
{
    return nOperationsAllowDispenseInTrainingMode;
}

bool ConfigObject::GetfOperationsPrintReceiptOnCancelledTransaction() const
{
    return fOperationsPrintReceiptOnCancelledTransaction;
}

void ConfigObject::GetHWConfig() // SSCOADK-3006
{ 
	HKEY hKey;
    _TCHAR  szValue[20];
				 ...
				 0, KEY_QUERY_VALUE, &hKey))
	{
		...
		if( ERROR_SUCCESS == RegQueryValueEx(hKey, _T("HWSpec"), NULL, NULL, (LPBYTE)szValue, &dwValueSize))
		{
		   csHWSpec = szValue;
        } 
        ::RegCloseKey(hKey);
               ...
               0, KEY_QUERY_VALUE, &hKey))
    {
        if( ERROR_SUCCESS == RegQueryValueEx(hKey, _T("Configure"), NULL, NULL, (LPBYTE)szValue, &dwValueSize))
		{
            csHWConfigure = szValue;
        }
        ::RegCloseKey(hKey);
    }
}

long ConfigObject::IsBagScaleDisabled(void) const
{
    return nBagScaleDisabled;
}

bool ConfigObject::GetfStateDisableAudioInAttendantMode(void)
{
    bool bReturn = fStateDisableAudioInAttendantMode;
...
bool ConfigObject::GetfStateAllowTBAudioControl(void) const
{
    return fStateAllowTBAudioControl;
}

bool ConfigObject::GetfStateSayPhrases(void) const
{
    return fStateSayPhrases;
}

bool ConfigObject::GetfStateForceWeighingOFPriceEmbedded(void) const
{
    return fStateForceWeighingOFPriceEmbedded;
}

bool ConfigObject::GetfStateSayPrices() const 
{ 
    return fStateSayPrices;
}

bool ConfigObject::GetfStateSayPricesDisableInAttendantMode() const 
{ 
    return fStateSayPricesDisableInAttendantMode;
}

CString ConfigObject::GetcsLocaleStoreName() const 
{ 
    return csLocaleStoreName;
}
