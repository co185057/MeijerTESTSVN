...
echo =
echo ---------------------------------------------------------------
echo Continuing 'SCOTApp - Win32 Unicode Release BuildLib'
%MSD% "%CURPROJSCOT%\ScotApp.dsw" /USEENV /MAKE "SCOTApp - Win32 Unicode Release BuildLib"  /OUT %LOGFILE%-UnicodeReleaseScotLib.log 

echo Continuing 'SCOTSSF - Win32 Unicode Release'
%MSD% "%CURPROJSCOT%\ScotApp.dsw" /USEENV /MAKE "SCOTSSF - Win32 Unicode Release" /OUT %LOGFILE%-UnicodeReleaseSSF.log

echo Continuing 'SCOTApp - Win32 Unicode Release'
%MSD% "%CURPROJSCOT%\ScotApp.dsw" /USEENV /MAKE "SCOTApp - Win32 Unicode Release" /OUT %LOGFILE%-UnicodeReleaseScot.log
