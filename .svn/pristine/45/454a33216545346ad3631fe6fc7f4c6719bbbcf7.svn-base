...
SMStateBase * SMSystemMessage2::Initialize(void)
{
    return SMSystemMessage2Base::Initialize();
}

bool SMSystemMessage2::DeliverDescriptorList(CDescriptorList &dlParameterList)
{
    return SMSystemMessage2Base::DeliverDescriptorList(dlParameterList);
}

CString SMSystemMessage2::getWaveFile()
{
    return SMSystemMessage2Base::getWaveFile();
}
