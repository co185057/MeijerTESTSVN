...
namespace RapNet
{
	...
	public class TransactionCount
	{
        ...
        /// </summary>
        public virtual void RefreshTransactionCount(int day)
        {
            try
            {
                CheckClear(day);
        ...
        /// </summary>
        protected virtual void ShowTransactionCountColor()
        {
            try
            {
                int totalTransactionCountByPeriod = TotalTransactionCountByPeriod(); 
 
				if (ConfigData.GetConfigData().TrxCountThresholdForHighAlert <= ConfigData.GetConfigData().TrxCountThresholdForCaution)
                {
                    if (totalTransactionCountByPeriod <= ConfigData.GetConfigData().TrxCountThresholdForHighAlert)
                    {
                        myPsx.psx.SetControlConfigProperty("TransactionCount", Psx.PropertyBackgroundColor,
                            myPsx.psx.GetConfigColor("HighAlertTrxCountThresholdColor"));
                    }
                    else if (totalTransactionCountByPeriod <= ConfigData.GetConfigData().TrxCountThresholdForCaution)
                    {
                        myPsx.psx.SetControlConfigProperty("TransactionCount", Psx.PropertyBackgroundColor,
