...
CRYPTOPP_DLL Integer NR_EncodeDigest(unsigned int modulusBits, const byte *digest, unsigned int digestLen);
CRYPTOPP_DLL Integer DSA_EncodeDigest(unsigned int modulusBits, const byte *digest, unsigned int digestLen);
...
//! .
class CRYPTOPP_DLL TrapdoorFunctionBounds
{
public:
...
//! .
class CRYPTOPP_DLL RandomizedTrapdoorFunction : public TrapdoorFunctionBounds
{
public:
...
//! .
class CRYPTOPP_DLL TrapdoorFunction : public RandomizedTrapdoorFunction
{
public:
...
//! .
class CRYPTOPP_DLL RandomizedTrapdoorFunctionInverse
{
public:
...
//! .
class CRYPTOPP_DLL TrapdoorFunctionInverse : public RandomizedTrapdoorFunctionInverse
{
public:
...
//! .
class CRYPTOPP_DLL TF_DecryptorBase : public TF_CryptoSystemBase<PK_FixedLengthDecryptor, TF_Base<TrapdoorFunctionInverse> >
{
public:
...
//! .
class CRYPTOPP_DLL TF_EncryptorBase : public TF_CryptoSystemBase<PK_FixedLengthEncryptor, TF_Base<RandomizedTrapdoorFunction> >
{
public:
...
//! .
class CRYPTOPP_DLL TF_DigestSignerBase : public TF_DigestSignatureSystemBase<DigestSigner, TF_Base<RandomizedTrapdoorFunctionInverse> >
{
public:
...
//! .
class CRYPTOPP_DLL TF_DigestVerifierBase : public TF_DigestSignatureSystemBase<DigestVerifier, TF_Base<TrapdoorFunction> >
{
public:
