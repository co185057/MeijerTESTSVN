...
const enum DATANEEDEDVIEWS
   ...
   DATANEEDED_INVALIDBARCODE, //SR879
   DATANEEDED_GO_TO_LANE,     //SR831
   DATANEEDED_PLA_VALIDATION,  //58 SSCOADK-260
   DATANEEDED_GOTOINPROGRESS,  //SSCOADK-493
   DATANEEDED_GENERICDELAYED,  //60 SSCOADK-2072
   DATANEEDED_CHECKONLANE,	 //RFC 356020
   DATANEEDED_CHECKONLANERAP, //RFC 356020
   DATANEEDED_MEIJERCARDVERIFICATION,	// CRD 526693
