...
__interface ITBGenObj : public IDispatch
{
	...
	[id(9), helpstring("method GetValue2 does not throw exceptions")] HRESULT GetValue2([in] BSTR Name, [out,retval] VARIANT* vValue);
};
...
public:
   ...
   STDMETHOD(StreamOut)(LONG* cb, BYTE** pBuffer);
	...
	STDMETHOD(GetValue2)(BSTR Name, VARIANT* vValue);
