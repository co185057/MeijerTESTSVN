...
const enum PSEVT
{
     ...
     PS_CHARKEY,
	  ...
	  PS_CMDATA,          // SR700
      PS_ADDOPERATOR,
      PS_ADDOPERATOR_AND_CONNECT,
      PS_SIGNATURE_START,
      PS_SIGNATURE_END,
	  // +RFQ 7477
	  PS_RAPBIOMET, // SSCOI-45441
	  PS_RAPCHECKIN,        //POS81634
      PS_RAPCHECKOUT,       //POS81634
      PS_RAPSCANNERENGAGED, // POS181195
      PS_RAPSCANNERAVAILABLE, // POS181195
      PS_RAPSCANNERUNAVAILABLE, // POS181195
	  PS_RAPSCANNERDEACTIVATED, //CRD149415
	  // -RFQ 7477
	  PS_RAPPRINTERBITMAPLOADED,
	  PS_RAPPRINTERBITMAPNOTLOADED,
	  PS_RAPPRINTERBITMAPLOADFAILED,

	  PS_AUTHENTICATION_REQUEST_OPTIONAL,
	  PS_AUTHENTICATION_REQUEST_REQUIRED,
	  PS_AUTHENTICATION_INVALID_ID,
	  PS_AUTHENTICATION_INVALID_PW,
      PS_AUTHENTICATION_SUCCESS,
...
//Flag values send in PostPS message's lParam indicating special handling
#define NOTIFY_USERINPUTCOMPLETED  0x01    //'OR'd Binary flag - notify NextGenUIUserInputCompleted that processing User input is complete    
//-Flag values
