...
//      4) Hide DOM and xml creation detials from the objects needing serialization.
//         Client object dos not need to know anything about building DOM, XML etc.
//     
// @author  TDonnan
//
// @date    2012/07/01
...
// @end
//*****************************************************************************
// $Header: p:/archives/POS/common/XmlUtils/XmlSerializer.cpp 1.17 2015/09/27 13:41:54Z jo185036 Exp $
//
// $Log: XmlSerializer.cpp $
// Revision 1.17  2015/09/27 13:41:54Z  jo185036
// ARENG-22493 - Migrate GPOS EFT 2.0 changes to 7.06.03
//                           Fixed CtiUnitTest.exe  failing to compile
// Revision 1.16  2015/03/18 01:33:50Z  jp210045
// ARENG-21625 Fix xml serializer so it properly sets the current node in one case
// Revision 1.15  2014/05/27 17:10:22Z  td210013
// ARENG-17999 Airtag Loyalty for Yum UK
// Revision 1.14  2013/09/17 14:56:08Z  ms185126
// ARENG-18362 - OnlineOrdering - CheckIn ApplyTende - Remove Error logging if no tag is found
// Revision 1.13  2013/07/19 18:16:22Z  ms185126
// ARENG-18189 - QSR Rework and Enhancements (7.07.04)
// Revision 1.12  2013/04/15 18:42:59Z  td210013
// ARENG-17598 ETransDocWrapper Update
//  - fixed blank receipt text problem
// Revision 1.11  2013/04/09 18:02:57Z  td210013
// ARENG-17596 ETransDocWrapper Update (7.07.04)
//   - Adding new member functions
//   - separted our implementation for the extended
//     serializer class
// Revision 1.10  2012/12/21 17:43:39Z  SB210046
// #16550 - ELoyalty
//   - something weird happend... a typo? really?
// Revision 1.9  2012/12/14 23:12:22Z  SB210046
// #16550 - ELoyalty integration
//   - updates to logging
// Revision 1.8  2012/11/28 20:24:44Z  SB210046
// #16550 - ELoyalty integration
//   - cleanup...
// Revision 1.7  2012/10/31 15:13:39Z  SB210046
// #13013 - CommCenter-ItemOutOfStock Bugs
//   - Comment out success debug/info logging
// Revision 1.6  2012/10/24 17:23:48Z  SB210046
// #16386 - GPos Complains when no CommCenterStatus.xml
//   - Chg info messages to debug
// Revision 1.4  2012/10/04 21:21:57Z  SB210046
// #13013 - CommCenter-ItemOutOfStock
//   - Msxml import strategy problem
// Revision 1.3  2012/10/04 17:43:32Z  SB210046
// #13013 - CommCenter-ItemOutOfStock
//   - Msxml import strategy problem
// Revision 1.2  2012/10/02 22:51:33Z  SB210046
// #13013 - CommCenter-ItemOutOfStock
//   - Add functionality to retrieve an MSXML doc instance
// Revision 1.1  2012/09/11 20:02:00Z  SB210046
// Initial revision
//
//****************************************************************************
...
////////////////////////////////////////////////////////////////////////
// @mfunc <c CXmlSerializer> serialize attribute tag and data
eXsRetValue CXmlSerializer::SerializeAttribute( LPCTSTR a_szTagName, LPCTSTR a_csValue )
{
   if ( NULL == m_ptrCurrentNode )
   {
      // LLOGERR((szXsEventLogComponent, _T("No Current Node for setting attribute: %s"), a_szTagName));
   ...
   HRESULT hr = m_ptrCurrentNode->setAttribute(a_szTagName, _bstr_t(a_csValue) );
   if ( FAILED ( hr ) )
   {
      // LLOGERR((szXsEventLogComponent, _T("Set attribute: %s failed, hr: 0x%p"), a_szTagName, hr));
      return eXsFailure;
...
////////////////////////////////////////////////////////////////////////
// @mfunc <c CXmlSerializer> serialize attribute tag and data
eXsRetValue CXmlSerializer::SerializeAttribute( LPCTSTR a_szTagName, int a_nValue )
{
   if ( NULL == m_ptrCurrentNode )
   {
      // LLOGERR((szXsEventLogComponent, _T("No Current Node for setting attribute: %s"), a_szTagName));
   ...
   HRESULT hr = m_ptrCurrentNode->setAttribute(a_szTagName, vt );
   if ( FAILED ( hr ) )
   {
      // LLOGERR((szXsEventLogComponent, _T("Set attribute: %s failed, hr: 0x%p"), a_szTagName, hr));
      return eXsFailure;
...
////////////////////////////////////////////////////////////////////////
// @mfunc <c CXmlSerializer> serialize attribute tag and data
eXsRetValue CXmlSerializer::SerializeAttribute( LPCTSTR a_szTagName, unsigned long a_ulValue )
{
   if ( NULL == m_ptrCurrentNode )
   {
      // LLOGERR((szXsEventLogComponent, _T("No Current Node for setting attribute: %s"), a_szTagName));
...
////////////////////////////////////////////////////////////////////////
// @mfunc <c CXmlSerializer> serialize attribute tag and data
eXsRetValue CXmlSerializer::SerializeAttribute( LPCTSTR a_szTagName, long a_lValue )
{
   if ( NULL == m_ptrCurrentNode )
   {
      // LLOGERR((szXsEventLogComponent, _T("No Current Node for setting attribute: %s"), a_szTagName));
   ...
   HRESULT hr = m_ptrCurrentNode->setAttribute(a_szTagName, _variant_t(a_lValue) );
   if ( FAILED ( hr ) )
   {
      // LLOGERR((szXsEventLogComponent, _T("Set attribute: %s failed, hr: 0x%p"), a_szTagName, hr));
      return eXsFailure;
...
_bstr_t CXmlSerializer::GetXml( void )
{
   if ( NULL == m_ptrDoc )
   {
