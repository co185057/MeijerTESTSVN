...
// RemoteConsoleMgrPpg.h : Declaration of the CRemoteConsoleMgrPropPage property page class.


// CRemoteConsoleMgrPropPage : See RemoteConsoleMgrPpg.cpp.cpp for implementation.
