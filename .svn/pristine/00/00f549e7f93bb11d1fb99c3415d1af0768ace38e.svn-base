...
SMStateBase *SMVoidItemBase::PSButtonGoBack(void) 
{
  ...
  {
	// Go back to Scan & Bag
	return setAndCreateAnchorState(BES_SCANANDBAG);               // return to S&B or EnterCoupons
  }
}
...
//*** NewUI ***//
  ...
  {
	if ((csCode == csDMLastBarCode) || (csCode == csDMLastBarLabel || csDMLastBarCode.Find(csCode) != -1 )) //RFC 412256
    {
      found = true;
    }
  }
