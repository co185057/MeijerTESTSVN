...
SMStateBase *SMCustomMessageBase::Initialize(void)
{
  ...
  bool bButtonFlash = true; //SSCOADK-1081
    //TAR 440550  - If in assist menu trim leading newlines and whitespaces
    //  to properly position custom message in display area
    if(co.IsInAssistMenus())
    {
        CustomMessageObj.csScreenText.TrimLeft();
        bButtonFlash = false;  //SSCOADK-1081
    }
  ps.CMButtonFlash(_T("CMButton1Med"),bButtonFlash);  //SSCOADK-1081
