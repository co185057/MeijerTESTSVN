...
long SMSmSystemFunctionsBase::CopyLogsToServer(void)
{
  ...
  to.CloseTraceFile();
  SMStateBase::SCOTDeleteFile(csSourceFileName);   //TAR 348946 - make sure you have an old traces.log somehow
  ...
  SMStateBase::SCOTDeleteFile(csSourceFileName);   //TAR 348946
  ...
  if (eLog)
  {
	...
	SMStateBase::SCOTDeleteFile(csSourceFileName);   //TAR 348946 - make sure you have an old system event log somehow
  ...
  if (eLog)
  {
	...
	SMStateBase::SCOTDeleteFile(csSourceFileName);   //TAR 348946 - make sure you have an old application event log somehow
    ClearEventLog(eLog, csSourceFileName);
