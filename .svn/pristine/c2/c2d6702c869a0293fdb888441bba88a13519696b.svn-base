...
// RFC 265463 end
#define WMU_RELOAD_OPTIONS (WM_USER + 107)
#define WMU_CONNECT_FP_DEVICE (WM_USER + 108)
#define WMU_DISCONNECT_FP_DEVICE (WM_USER + 109)
...
class TraceObject;
class DLLEXPORT
 MsgObject : public CObject, public IMsgObject
{
private:
...
public:
    ...
    long PostPS( const int, const long, const long, const CString&, const long=0);  // SSCOI-45254
