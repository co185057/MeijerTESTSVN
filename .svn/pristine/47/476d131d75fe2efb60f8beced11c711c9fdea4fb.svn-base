========================================================================
    ACTIVE TEMPLATE LIBRARY : tbControls Project Overview
========================================================================

AppWizard has created this tbControls project for you to use as the starting point for
...
_tbControls.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_tbControls.h)
        GUID definitions                                (_tbControls_i.c)
        A type library                                  (_tbControls.tlb)
        Marshaling code                                 (_tbControls_p.c and dlldata.c)
tbControls.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named tbControls.pch and a precompiled types file named StdAfx.obj.
...
tbControlsps.vcproj
	...
	dlldata.c, tbControls_i.c and tbControls_p.c which are required
