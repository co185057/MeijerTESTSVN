...
void CBase64EncodeDecode::Base64Encode(const void* pSrc, const size_t nLen, LPSTR szDest)
{
...
CString CBase64EncodeDecode::DecodeString(CString csEncodedData)
{
    ...
    char *myANSIdata;
    int myANSIDataSize = 0;
    int nBufferSize=wcslen (sBuffer);
#ifdef _UNICODE
...
void CBase64EncodeDecode::Base64Decode(const void* pSrc, const size_t nLen, LPSTR szDest)
{
