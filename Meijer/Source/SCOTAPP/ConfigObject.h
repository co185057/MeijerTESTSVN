...
class DLLEXPORT
#endif
 ConfigObject : public CObject, public IConfigObject
{
private:
  ...
  int  nTimeOutThankYouTimerNoBagScale;
  ...
  int  nTimeOutPrintReceiptInThankYouScreenTimer;   //SR832
  ...
  int  nTimeOutEnterWeightTimer; // SR814.2
  int  nTimeOutRemoveItemFromProduceScaleAudio;
  // +-SSCOADK-5902
  int  nTimeOutCMMoneyInsertedTimer;
...
public:
 ...
 // int nOperationsTobaccoAge;        // minimum age in years for purchasing rest'd items // tobacco etc.
  ...
  bool fOperationsEnableMSRDegradedModeCashOnly;
  virtual bool GetfOperationsAllowSkipBaggingBtn(void) const;
  ...
  virtual CString GetcsOperationsOperatorBarcodeMask(void) const;
  bool fOperationsAllowLeadingZerosInCode128LoginBarCode; //rfc 240738
  int nOperationsOperatorLoginBarcodeHeight; //Tar 430804
  bool fOperationsShowItemRemovedButtonOnRemoveItemViolationScreen; //CHU 07/25/02 RFC 208874
  bool GetfOperationsShowItemRemovedButtonOnRemoveItemViolationScreen(void) const;
  bool fOperationsAllowContainerBtn;
  bool GetfOperationsAllowContainerBtn(void) const;
  bool fOperationsDisableUnexpIncContainerBtnAftFirstItem; 
  bool GetfOperationsDisableUnexpIncContainerBtnAftFirstItem(void) const;
  bool fOperationsAllowContainerBtnForMismatching;       // Tar 266250
  bool GetfOperationsAllowContainerBtnForMismatching(void) const;
  bool fOperationsAllowContainerBtnInFinalization;//SR085
  bool GetfOperationsAllowContainerBtnInFinalization(void) const;
  ...
  bool GetfOperationsSuppressAudioInUnexpectedIncrease(void) const;
  bool fOperationsSuppressAudioInMismatch;  // 3.2 patch B - RFC 257449
  bool GetfOperationsSuppressAudioInMismatch(void) const;
  ...
  bool GetfOperationsScaleMetric(void) const;
  int nOperationsTareContainer1;      // value 0-10 for SelectContainer button 1
  virtual int GetnOperationsTareContainer1(void) const;
  int nOperationsTareContainer2;      // value 0-10 for SelectContainer button 2
  virtual int GetnOperationsTareContainer2(void) const;
  ...
  bool GetfOperationsAllowMultiPick(void) const;
  bool fOperationsAllowMultiPick;
  bool fOperationsDisplayPickListItemCode;
  bool GetfOperationsDisplayPickListItemCode(void) const;
  bool fOperationsDisplayQuickPickItems;
  bool fOperationsDisplayPickListSubCategoriesInTab;
  bool fOperationsHighlightFirstCategoryFromSearch;
  ...
  bool GetfOperationsPrintReceiptOnCancelledTransaction(void) const;
  bool fOperationsPersonalizationReceipt; //SR Personalization Digital Receipt
  ...
  bool fOperationsEnablePartialCut; // SSCOADK-4473 Prevent R6 Receipt Printer from dropping receipts on the floor
...
//Fiscal Printer end
  ...
  bool GetfOperationsAutoVoidUnderageRestrict(void) const;
  ...
  virtual int GetnOperationsAllowDispenseInTrainingMode(void) const;
  bool fOperationsInterventionAtStartOfTrainingModeTransaction; // RAP Intervention in Training Mode cs185088
  virtual bool GetfOperationsInterventionAtStartOfTrainingModeTransaction(void) const;
  ...
  virtual int GetnOperationsGiftCardRedemption(void) const;
  ...
  virtual bool GetfOperationsEnableUSSF(void) const;
  //USSF END
  ...
  bool fOperationsCustomerBagAllowedInScanAndBag; //SR880

  bool fOperationsAllowPickListSearchButton;
  bool GetfOperationsAllowPickListSearchButton(void) const;
  bool fOperationsAllowFuzzySearch;
  bool GetfOperationsAllowFuzzySearch(void) const;

  CString csOperationsReceiptBarcodeDataTextToBinaryDecoder;
  bool fOperationsEncodeDataAsPackedBCD;

  bool fOperationsEnableSecurityInCMDataNeeded;//SR801
  bool fOperationsShowRapInfoWhenAbnormalBalance;   // Add Glory CM Support

  bool fStateSayPrices;                     // flag value Y/N
  virtual bool GetfStateSayPrices(void) const;
  bool fStateSayPricesDisableInAttendantMode;  // TAR 330578 - Disable SayPrice during AttendantMode
  virtual bool GetfStateSayPricesDisableInAttendantMode(void) const;
  bool fStateSayPhrases;                    // flag value Y/N
  bool fStateAllowTBAudioControl;           // flag value Y/N
  bool fStateLiveVideo;                     // flag value Y/N
  virtual bool GetfStateLiveVideo(void) const;
  ...
  bool GetfStateForceWeighingOFPriceEmbedded(void) const;
  ...
  bool GetfStateAttndModeAllowed(void) const;
  ...
  bool fStateAttndModeImmedInterventions;  //Handle interventions immediately (Y or N)
    ...
    //+SR814.2
  bool fStateAcceptWeightBeepEnable;
  bool fStateAcceptWeightBtnEnable;
  //-SR814.2
  ...
  bool fStateContextSensitiveMenus;             //SR819
  bool fStateAssistMenuDuringFinalization;      //SR819
  CString csStateAssistMenuFinalizeContext;     //SR819
  CString csStateAssistMenuFinalizeHeadCashier; //SR819
  CString csStateAssistMenuItemizeContext;      //SR819
  CString csStateAssistMenuItemizeHeadCashier;  //SR819 
  
    bool fStateSecurityDisableAllowed; //SR683
    virtual bool GetfStateSecurityDisableAllowed(void) const;
    bool fStateSecurityDisableNoReset; //SR683
  
  bool GetfStateDisableAudioInAttendantMode(void);
  bool GetfStateSayPhrases(void) const; 
  bool GetfStateAllowTBAudioControl(void) const;
  ...
  virtual int GetnTracingCurrentLevel(void) const;
...
//bool fTenderEBTFSCashBack;          // EBT FS tender allows cash back no longer used
  ...
  virtual bool GetfTenderSubmitFSTtotalIfMorethanTrxTotal(void) const;
  bool fTenderIsMotorizedMSR;         // using Motorized MSR Y or N
  virtual bool GetfTenderIsMotorizedMSR(void) const;
  ...
  virtual bool GetfTenderDispenseChangeAtLaneForRemoteTendering(void) const;
  ...
  virtual bool GetfUserExitAllEnabled(void) const;
  ...
  virtual bool GetfUserExit00Enabled(void) const;
  ...
  virtual CString GetcsDataTareFile() const;

  CString csDataDefaultImagePath;
//New UI
  CString csDataXMLFile;            // XML file name
  virtual CString GetcsDataXMLFile() const;
//End New UI
  CString csDataEntryINIFile;       // DATAENTRY ini file
  virtual CString GetcsDataEntryINIFile() const;
  ...
  int getTimeOutTakeReceipt()         { return nTimeOutTakeReceipt; }
  ...
  int getTimeOutPrintReceiptInThankYouScreenTimer() { return nTimeOutPrintReceiptInThankYouScreenTimer; }  //SR832
  ...
  int getTimeOutThankYouTimerNoBagScale() { return nTimeOutThankYouTimerNoBagScale; }
  ...
  int getTimeOutEnterWeightTimer() { return nTimeOutEnterWeightTimer; } //SR814.2
  int getTimeOutRemoweItemFromProduceScaleAudio() { return nTimeOutRemoveItemFromProduceScaleAudio; }
  // +-SSCOADK-5902
  int getTimeOutCMMoneyInsertedTimer() {return nTimeOutCMMoneyInsertedTimer;}
  
    //BeginCodeLocale

    //+SR834 - options to show store name and number on CM receipt header
    CString csLocaleStoreName;
    virtual CString GetcsLocaleStoreName() const;
    CString csLocaleStoreDescriptor;
    bool fLocaleShowStoreOnReport;
    //-SR834
    ...
    CString csLocaleDecimalSymbolForNumber;	// NUMBERFMT lpDecimalSep  
  ...
  bool fLocaleDisplayCashManagementAtRAP;  //SR969 - View CM at the RAP
  ...
  virtual bool GetfOperationsHopperSubstitutionIntervention(void) const;
  ...
  bool fLocaleAltF4ExitAllowed;         // Y/N Default to Y -   Allow Alt-F4 to exit scotapp.exe?
  bool fLocaleLeaveCashAcceptorsEnabledDuringTransaction;  //SSCOADK-836
  bool fLocaleDisableCashAcceptorsDuringItemization;
...
//  int nCashLowList [MAX_LISTVALUE];   // Low thresholds for the green blinking
  ...
  //-dp185016 capacity
    ...
    virtual CString GetcsTemplateAssistMode() const;
    //Begin Tar 210104
...
//  CString getMessageFile() const          { return csDataMessageFile;}
    ...
    virtual CString GetcsPrimaryLanguageCode(void);
    SLanguageInfo language[SCOT_LANGUAGE_MAX];
	virtual SLanguageInfo Getlanguage(int index) const;
    void LoadLanguageOptions(IScotWinApp *pApp); // pApp has SCOTOPTS.000/xyz profile
    ...
    void InitPickListAssistOptions();
	...
	virtual TenderButton GetTenderButton(SCOT_LANGUAGE_TYPE language, int nButtonIndex) const;
   ...
   ////// AutoRun Config Options
    bool fAutoRunOn;
    virtual void SetfAutoRunOn(bool bAutorun);
    virtual bool GetfAutoRunOn(void) const;
    bool fAutoRunBypassBagging;
    virtual bool GetfAutoRunBypassBagging(void) const;
    ...
    virtual void SetfAutoRunAssistModeOn(bool bAutoRunAssistModeOn);
    virtual bool GetfAutoRunAssistModeOn(void) const;
    ...
    int GetNumberOfLanguagesSupported(void) const;
	...
	CArray<SBmpPrintWidths,SBmpPrintWidths> caBarcodePrintWidth; //SSCOADK-2504
    int GetSizeAndDataInSection(LPCTSTR szSection, LPCTSTR szFileName, LPTSTR &szData); //SSCOADK-2504
	...
	//+SSCOADK-264
	bool IsPicklistAssistEnable() const;
    int  GetPicklistThreshold() const;
    int  GetValidationThreshold() const;
    int  GetPickListHashTableSize() const;
    int  GetVVResponseWaitTimeout() const;
   	//-SSCOADK-264
    bool GetAllowPLAAutoAdvance() const;

    bool GetfOperationsPicklistSortedAlphabetical(void) const;
    bool GetfOperationsUsePicklistXMLImageName(void) const;
    bool GetfOperationsTakeChangeBypassedIfNoBills(void) const;
    //RFC 334227
    ...
    CString GetcsPicklistImagePath(void) const;
    CString csPicklistImageConfiguredResolution;    //TAR 431887 configured resolution in registry \software\ncr\scot\installation\media
    CString csShrinkPicklistImageCMD;
    bool ShowRapInfoWhenAbnormalBalance(void) const { return fOperationsShowRapInfoWhenAbnormalBalance; }       // Add Glory CM Support
    long IsBagScaleDisabled(void) const;
...
public:
    ...
    void SetSecurityDisableSubCheck(bool bValue);
    bool GetSecurityDisableSubCheckOn();
...
protected:
    ...
    bool m_bSecurityDisableSubCheck;//SR814.4

    void GetHWConfig();           //SSCOADK-3006
//+SSCOADK-264
  int nOperationsPicklistThreshold;
  int nOperationsValidationThreshold;
  int nTimeOutVVResponseWaitTimeout;
  int nOperationsPickListHashTableSize;
  bool fOperationsPicklistAssistEnable;
  //-SSCOADK-264
  bool fOperationsAllowPLAAutoAdvance;

  bool fOperationsPicklistSortedAlphabetical;
  bool fOperationsUsePicklistXMLImageName;

  bool fOperationsTakeChangeBypassedIfNoBills;

  long nBagScaleDisabled;

  bool fOperationsEncodeOperatorIDPW;

  //state
  bool fStateDisableAudioInAttendantMode;  // Disable audio during AttendantMode


//SR81 begin
public:
    CString csHWType;           //SSCOADK-3006
    CString csHWSpec;           //SSCOADK-3006
    CString csHWConfigure;      //SSCOADK-3006
...
// (+) SR898 ====================
public:
    bool fOperationsInvertLightStates;
    virtual bool GetfOperationsInvertLightStates(void) const;
// (-) SR898 ====================
    ...
    //-SR713
    bool fStateTenderStartedMessage;    //SR797
    bool fOperationsAllowSMMKeyInCode;  //SR821    
// End of Dynamic configuration options

    bool fOperationsOperatorNumericKeyPad;
    virtual bool GetfOperationsOperatorNumericKeyPad(void) const;
    int nOperationsOperatorIDMaxDigit;
    virtual int GetnOperationsOperatorIDMaxDigit(void) const;
    int nOperationsOperatorPWMaxDigit;
    virtual int GetnOperationsOperatorPWMaxDigit(void) const;
    virtual bool GetfOperationsEncodeOperatorIDPW(void) const;

    bool fOperationsSendPOSOperatorBarcode;
    virtual bool GetfOperationsSendPOSOperatorBarcode(void) const;
    virtual int GetnOperationsOperatorLoginBarcodeType(void) const;
    virtual bool GetfOperationsAllowLeadingZerosInCode128LoginBarCode(void) const;

    CString csOperationsDefaultSendPOSOperatorPassword;
    virtual CString GetcsOperationsDefaultSendPOSOperatorPassword(void) const;

    bool fOperationsAllowSaleofRestrictedItems;
    virtual bool GetfOperationsAllowSaleofRestrictedItems(void) const;

    bool fOperationsAllowSaleofRestrictedItemsInAssist;
    virtual bool GetfOperationsAllowSaleofRestrictedItemsInAssist(void) const;

    // SSCOADK-2522: Need to handle printing signature on 80mm (default) or 58mm receipt paper
    int nPrintObjectsSignatureWindowWidth;
    int nPrintObjectsSignatureWindowHeight;
    int GetSignatureWindowWidth() const { return nPrintObjectsSignatureWindowWidth; }
    int GetSignatureWindowHeight() const { return nPrintObjectsSignatureWindowHeight; }

    bool fOperationsEnableTopazSignatureBoldness;
    int nPrintObjectsTopazSignatureBoldness;
    int GetTopazSignatureBoldness() const { return nPrintObjectsTopazSignatureBoldness; } 

private:
    static void CheckRange(int &lValue, const int lMin, const int lMax);
    static CString GetOptStr(IScotWinApp* pApp, LPCTSTR szSect, LPCTSTR szKey, LPCTSTR szDflt, const bool fError);
    static int GetOptInt(IScotWinApp* pApp, LPCTSTR szSect, LPCTSTR szKey, const int nDflt, const bool fError);
    static int CleanOptIntArray(LPCTSTR szSect, LPCTSTR szKeyBase, const int iMaxSize, int values[], const int iTargetValue);
    static int GetOptIntArray(IScotWinApp* pApp, LPCTSTR szSect, LPCTSTR szKeyBase, const int numValues, int values[], const int nDflt, const bool fError, const bool fStoreValIfDefault);
    static bool GetOptFlg(IScotWinApp* pApp, LPCTSTR szSect, LPCTSTR szKey, const bool fDflt, const bool fError, bool *bRead =false);
};
