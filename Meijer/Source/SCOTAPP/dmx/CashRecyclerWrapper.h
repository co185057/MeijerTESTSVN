...
public:
   ...
   CString GetLowIndicatorList( void );
    ...
    /**
     * Read the glory cassette counts
     * \param[out]  pCashCounts - holds the current cassette counts   
     * \return true on success, false on failure
     * \note Added for Add Glory CM Support feature
     */
    virtual long ReadCassetteCounts(BSTR* pCashCounts); 
...
private:
   ...
   long ReadCashCountsInternal( CString& sResult, BOOL &bDiscrepancy ); // Add Glory CM Support
   ...
   CCashCounts ReadCassetteCounts(void);
...
private:
   ...
   bool m_bSubtractCassetteCounts;

    /**
     * Check recycler cash unbalance status
     * \param[in]  void    
     * \return true if cash recycler has cash unbalance status,
     *         false, otherwise.
     * \note Added for Add Glory CM Support feature
     */
    bool CheckCashBalanceStatus(void);  
