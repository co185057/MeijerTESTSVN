...
#include "FakeRAInterface.h"
#include "FakeKVParmList.h"
#endif //CPPUNIT
#include "IRAProcedures.h"
...
class DLLEXPORT
#endif 
  RAProcedures : public CWnd, public IRAProcedures
{
#ifndef _CPPUNIT
public:
    ...
    DECLARE_KV_HANDLER_CLASS_BEGIN(ConnectParms)
        ...
        DECLARE_KV_LONG(RAPLite)
        DECLARE_KV_CSTRING(DeviceType)
...
#ifndef _CPPUNIT
    bool m_bDoRCMgrInit;
	CString m_csStateName;	//TAR437218
...
// Operations
public:
	virtual BOOL OnNoSaleApproval( void );  //sscoadk-321
	virtual void OnNoSale(LPCTSTR desc);    //sscoadk-321
    ...
    //TAR 192098 end
#endif //CPPUNIT
    virtual int GetRAPGenericDelayedPendingCount( void ) const;
    virtual void OnGenericDelayedIntervention(
                              LPCTSTR  sDesc,
                              LPCTSTR  sID,
    ...
    virtual void OnGenericDelayedApproval( LPCTSTR  sID, int nRptID, bool bRemote = false );

    virtual void OnAssistModeNotAvailable(void);
    virtual void OnAssistModeAvailable(void);

#ifndef _CPPUNIT
    //+SR831
    void OnDisableHandlingAtLocation(CString desc ); 
    void OnEnableHandlingAtLocation( void );
    //-SR831
    /* 1. Age Restriction operations */
    void OnNoAgeRestrictions( void );
    void OnAgeRestrictedItem( LPCTSTR desc,int nMinAge, long lNumberOfUnapprovedRestrictedItems, BOOL bVoided, BOOL bDOBNotNeededBtn = true ); //SR803
  ...
  // +RFQ 7477
    //POS81634
     BOOL CheckIn( const CString &sRemoteConnectionName
               , const CString &sUserId
               , const CString &sUserPwd
               , BOOL bValid
               , int iReason
    ...
    //Transfered from SMStateBase
    void addOperatorID(CString csRapName, CString csOpID);  //RFC2054
    CString getOperatorID(CString csRapName);  //RFC2054
    void addRAPValidHeadCashier(CString csRapName, bool csOpType);  //SR819 
    bool getRAPValidHeadCashier(CString csRapName);
	CString GetHookProperty(CString csProp);	//CRD 3456798

public:

    static bool RAProcedures::EventHandler( CPSX *pPSX
                                          , PPSXEVENT pEvent );
    static long GetInterventionCount() { return m_lInterventionCount; }
...
// +RFQ 7477
    //POS81634 - rrs
    virtual BOOL CheckIn( PPSXEVENT pEvent );
    virtual bool CheckOut( PPSXEVENT pEvent );
    //e POS81634 - rrs
// -RFQ 7477
    ...
    virtual bool BiometricData( PPSXEVENT pEvent ); // RFQ 7477
    virtual bool RemoteData( PPSXEVENT pEvent );
    virtual bool AddOperator( PPSXEVENT pEvent );
...
private:
    ...
    BOOL OnApproval( const _TCHAR *pszApprovalType, bool bGenericDelayed = false );
#ifndef _CPPUNIT
...
// -RFQ 7477
public:
	void UpdateInterventionWaitTimes(long totalWaitTimeSec );
};
