...
class CXmlSerializer // : public CComprisEvtLog
{
   ...
   public:
      ...
      ////////////////////////////////////////////////////////////////////////
      // @cmember,mfunc serialize attribute tag and data
      eXsRetValue SerializeAttribute( LPCTSTR a_szTagName, LPCTSTR a_csValue );

      ////////////////////////////////////////////////////////////////////////
      // @cmember,mfunc serialize attribute tag and data
      eXsRetValue SerializeAttribute( LPCTSTR a_szTagName, int a_nValue );

      ////////////////////////////////////////////////////////////////////////
      // @cmember,mfunc serialize attribute tag and data
      eXsRetValue SerializeAttribute( LPCTSTR a_szTagName, unsigned long a_ulValue );

      ////////////////////////////////////////////////////////////////////////
      // @cmember,mfunc serialize attribute tag and data
      eXsRetValue SerializeAttribute( LPCTSTR a_szTagName, long a_lValue );
