...
# PROP Scc_ProjName "$/SCOTx Software/Source/Release 2.0/Core/source/scotrans", RGBCAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(MEIJER605)\adk\include" /D "_WINDOWS" /D "_AFXDLL" /D "WIN32" /D "_DEBUG" /D "SCOT_BUILD" /D "_SCOT" /FR /Yu"stdafx.h" /FD /c
...
"$(ProjDir)\tbmklist.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	$(ProjDir)\awkc.exe -o $(ProjDir)\tbmklist.exe -f $(InputPath)
...
SOURCE=.\STLViewerFilterDialog.cpp
# End Source File
# Begin Source File
...
SOURCE=.\STLViewerFilterDialog.h
# End Source File
# Begin Source File
...
SOURCE=$(MEIJER605)\ADK\Include\TransBroker.h
...
ProjDir=.
InputPath=$(MEIJER605)\ADK\Include\TransBroker.h
