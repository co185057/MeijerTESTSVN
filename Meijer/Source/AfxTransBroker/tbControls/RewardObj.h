...
__interface IRewardObj : public IDispatch
{
	...
	[propget, id(9), helpstring("property RewardPoints")] HRESULT RewardPoints([out, retval] LONG* pVal);
	[propput, id(9), helpstring("property RewardPoints")] HRESULT RewardPoints([in] LONG newVal);
};
