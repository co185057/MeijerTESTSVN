...
class CRYPTOPP_DLL HMAC_Base : public VariableKeyLength<16, 0, UINT_MAX>, public MessageAuthenticationCode
{
public:
...
template <class T>
class HMAC : public MessageAuthenticationCodeFinalTemplate<HMAC_Base, HMAC<T> >
{
public:
