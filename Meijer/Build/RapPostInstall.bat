...
rem ***** POS32528 Not Needed Anymore as Meijer uses 7167 printer already in all stores ***********
rem echo. >> %INSTLOG%
rem echo ********************************************************************  >> %INSTLOG%
rem echo %date% %time% >> %INSTLOG%
rem echo Updating the RAP Printer emulation/software to 7167 Mode... >> %INSTLOG%
rem %1\bin\BinOutSerial.exe NCRPOSPrinter.1 %1\bin\SetTo7167Mode.bin
rem type result.log >> %INSTLOG%
rem del /f /q result.log
rem echo Update complete -- Manually verify Emulation/Software settings in  >> %INSTLOG%
rem echo the printer hardware Diagnostics Form >> %INSTLOG%
rem echo ********************************************************************  >> %INSTLOG%
rem  **** e POS32528
