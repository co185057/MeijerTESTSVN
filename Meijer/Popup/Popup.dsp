...
!MESSAGE "Popup - Win32 Release Unicode" (based on "Win32 (x86) Application")
!MESSAGE "Popup - Win32 Debug Unicode" (based on "Win32 (x86) Application")
!MESSAGE 

# Begin Project
# PROP AllowPerConfigDependencies 0
# PROP Scc_ProjName ""$/SCOTx Software/Source/Release 3.0/Platform/Utility/Popup", AVOHAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
SOURCE="$(InputPath)"
PostBuild_Cmds=copy ..\popup\release\popup.exe c:\scot\bin
...
# ADD LINK32 /nologo /subsystem:windows /debug /machine:I386 /out:"Debug/PopupD.exe" /pdbtype:sept
...
LINK32=link.exe
# ADD BASE LINK32 /nologo /subsystem:windows /machine:I386
# ADD LINK32 /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /machine:I386 /out:"Release_Unicode/PopupU.exe"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy .\release_Unicode\popupU.exe c:\scot\bin
# End Special Build Tool
...
LINK32=link.exe
# ADD BASE LINK32 /nologo /subsystem:windows /debug /machine:I386 /pdbtype:sept
# ADD LINK32 /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /debug /machine:I386 /out:"Debug_Unicode/PopupUD.exe" /pdbtype:sept
