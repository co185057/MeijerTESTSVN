...
//
// $Header: /Integration_Customer/Meijer/CURRENT_DEV/Platform-Core-Patch/Core/SCOTServices/MsgObject.cpp 5     1/05/10 8:41p Cu185008 $
//
// AUTHOR:  DcL-
//
//////////////////////////////////////////////////////////////////////////////////////////////////
...
MsgObject::MsgObject(HWND hWnd, TraceObject* pTO):hw(hWnd)	// constructor
{
    ...
    long MsgObject::PostPS( const int  nPS, const long lPrm, const long wPrm, const CString& strContext )
    {
   ...
   const long lDirectIONumData)
    {
      ...
      if (vDPtr && lCodeOrLength>0 && lCodeOrLength<1000)
      {
