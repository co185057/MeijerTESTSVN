...
-------------------------------------------------------------------------------
$Archive: /Integration_Solution/ACS_Solution/CURRENT_DEV/Source/include/TransBroker.h $
$Revision: 4 $
$Date: 5/04/09 8:34a $
-------------------------------------------------------------------------------
*/
...
typedef enum
{
	...
	TB_TENDER_CHECK_LANE,		  // 44 RFC 356020
	TB_TENDER_CHECK_LANE_RAP,		  // 45 RFC 356020
