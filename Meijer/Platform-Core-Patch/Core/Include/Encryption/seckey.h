...
class BlockCipherBaseTemplate : public AlgorithmImpl<SimpleKeyingInterfaceImpl<BASE, INFO>, INFO>, public INFO
{
public:
...
/*
#define CRYPTOPP_DLL_TEMPLATE_CLASS_BlockCipherBaseTemplate(Info)	\
CRYPTOPP_DLL_TEMPLATE_CLASS TwoBases<Info, BlockCipher>;	\
CRYPTOPP_DLL_TEMPLATE_CLASS SimpleKeyingInterfaceImpl<TwoBases<Info, BlockCipher> >;	\
CRYPTOPP_DLL_TEMPLATE_CLASS AlgorithmImpl<SimpleKeyingInterfaceImpl<TwoBases<Info, BlockCipher> > >;	\
CRYPTOPP_DLL_TEMPLATE_CLASS BlockCipherBaseTemplate<Info>;
*/
...
//! .
template <class BASE, class INFO = BASE>
class MessageAuthenticationCodeFinalTemplate : public 
...
{
public:
 	MessageAuthenticationCodeFinalTemplate() {}
	MessageAuthenticationCodeFinalTemplate(const byte *key)
		{SetKey(key, DEFAULT_KEYLENGTH);}
	MessageAuthenticationCodeFinalTemplate(const byte *key, unsigned int length)
		{SetKey(key, length);}
	...
	Clonable * Clone() {return new MessageAuthenticationCodeFinalTemplate<BASE, INFO>(*this);}
};
