...
#define RA_STATE_CASHDRAWER_OPEN	8
#define RA_STATE_CASHDRAWER_CLOSE	9
...
#define RA_CAT_COUPON           RA_CAT_BITMAP(26)   
#define RA_CAT_HOPPERSUBSTITUTION    RA_CAT_BITMAP(27)   // 0x04000000
#define RA_CAT_SUSPENSIONDECLINED	RA_CAT_BITMAP(28)	// 0x08000000	// TAR 352409

#define RA_CAT_ALL            0xFFFFFFFF

// Make sure the following symbol is ALWAYS #defined to be the LAST category
#define RA_CAT_MAX            30
