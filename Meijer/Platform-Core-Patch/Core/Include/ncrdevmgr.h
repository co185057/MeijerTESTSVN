...
//
// $Archive: /Integration_Customer/Meijer/CURRENT_DEV/Platform-Core-Patch/core/Include/ncrdevmgr.h $
//
// $Revision: 3 $
//
// $Date: 10/29/08 4:31p $
...
#define DM_PTR_ERR_REPLACE_HEAD	    27
#define DM_PTR_ERR_SIDEWAYS_COMMS_ERROR	28
#define DM_PTR_ERR_EJECT_JAM	    29
