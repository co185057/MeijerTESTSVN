#pragma once
// $Header: /Integration_Customer/Meijer/CURRENT_DEV/Platform-Core-Patch/Core/Include/RCMKeyValue.h 8     1/05/10 8:38p Cu185008 $
/*
 * @(#)RemoteAppMgrKeyValue.h    $Revision: 8 $ $Date: 1/05/10 8:38p $
 *
 ...
 */
/*
* $Log: /Integration_Customer/Meijer/CURRENT_DEV/Platform-Core-Patch/Core/Include/RCMKeyValue.h $
 * 
 * 8     1/05/10 8:38p Cu185008
 * Migrating Core to G2.
 * 
 * 7     4/30/09 10:59a Sm133076
 * 381428 Meijer lab 4.32.6 FL Reports: Daily Summary Report by Cashier
 * are reporting incorrect operator ID
 * 
 * 6     4/30/09 8:56a Sm133076
 * 381428 Meijer lab 4.32.6 FL Reports: Daily Summary Report by Cashier
 * are reporting incorrect operator ID
 * 
 * 5     10/29/08 4:38p Sm133076
 * Patch G
 * 
 * 4     8/26/08 5:37p Sa250050
 * RFC380920
 * 
 * 2     6/23/08 7:58p Sa250050
 * RAP Cash Drawer Open/Close
 * 
 * 4     8/01/07 3:19p Cv185012
 * Patch E5 Migration.
 * 
