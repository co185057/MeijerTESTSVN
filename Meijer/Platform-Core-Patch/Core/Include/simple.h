...
class CRYPTOPP_DLL HashTransformationWithDefaultTruncation : public HashTransformation
{
public:
...
class CRYPTOPP_DLL Store : public AutoSignaling<InputRejecting<BufferedTransformation> >
{
public:
...
class CRYPTOPP_DLL Sink : public BufferedTransformation
{
protected:
