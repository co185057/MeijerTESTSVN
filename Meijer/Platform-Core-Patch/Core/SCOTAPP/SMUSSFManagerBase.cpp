...
void SMUSSFManagerBase::UnInitialize(void)
{
  ...
  // Do not clear context - this can be problematic in cases where leaving USSF only briefly.
  // Such as to handle a system message.
  //CString csTempstr;
  //csTempstr.Format(_T("Clearing Active Context (%s)."), GetActiveContext());
  //trace(L5, csTempstr);
  //SetActiveContext(_T(""));
}
...
SMStateBase *SMUSSFManagerBase::PSButton1(void)
{
  ...
  // Need to look up the event!
  // Get the ID of the button!
  CString csID;
  long rc = myDisplayShop -> ControlManager.GetDisplayMapElement(_T("Button1"), BUTTON1, csID);
  if (rc != 0)
  {
    //ERRHANDLE(_T("PSXEventError"), _T("Button1"), _T("USSFSelection::PSButton1()"), _T("GetDisplayMapElement()"));
    trace(L5, _T("Unable to Resolve Event Reference; using Default."));
  }
  else
  {
    trace(L7, _T("PSButton1=ID<%s>."), csID);
  }
  ...
  rc = myDisplayShop -> GetButtonInfo(csControlGroup, csID, csPendingEvent, csData);
  if (!rc)
  {
	  csPendingEvent = _T("PSButton1");
  }

  //SetPendingEvent(csPendingEvent);
  USSFutil.SetMetaData(csData);
  //csPOSData += csData;	// Protected Data From Base (may wish to encapsulate).

  SMStateBase *returnState = STATE_NULL;

  // As long as returnState is STATE_NULL, then process next context and/or next state
  // from custom data read earlier.
  if (returnState == STATE_NULL)
  {
    // Determine next move!
    //returnState = MakeNextMove();
...
SMStateBase *SMUSSFManagerBase::PSButton2(void)
{
  ...
  // Get the ID of the button!
  CString csID;
  long rc = myDisplayShop -> ControlManager.GetDisplayMapElement(_T("Button2"), BUTTON2, csID);
  if (rc != 0)
  {
    //ERRHANDLE(_T("PSXEventError"), _T("Button2"), _T("USSFSelection::PSButton2()"), _T("GetDisplayMapElement()"));
    trace(L5, _T("Unable to Resolve Event Reference; using Default."));
  }
  else
  {
    trace(L7, _T("PSButton2=ID<%s>."), csID);
  }
...
SMStateBase *SMUSSFManagerBase::PSButton3(void)
{
  ...
  // Get the ID of the button!
  CString csID;
  long rc = myDisplayShop -> ControlManager.GetDisplayMapElement(_T("Button3"), BUTTON3, csID);
  if (rc != 0)
  {
    //ERRHANDLE(_T("PSXEventError"), _T("Button3"), _T("USSFSelection::PSButton3()"), _T("GetDisplayMapElement()"));
    trace(L5, _T("Unable to Resolve Event Reference; using Default."));
  }
  else
  {
    trace(L7, _T("PSButton3=ID<%s>."), csID);
  }
...
SMStateBase *SMUSSFManagerBase::PSButton4(void)
{
  ...
  // Get the ID of the button!
  CString csID;
  long rc = myDisplayShop -> ControlManager.GetDisplayMapElement(_T("Button4"), BUTTON4, csID);
  if (rc != 0)
  {
    //ERRHANDLE(_T("PSXEventError"), _T("Button4"), _T("USSFSelection::PSButton4()"), _T("GetDisplayMapElement()"));
    trace(L5, _T("Unable to Resolve Event Reference; using Default."));
  }
  else
  {
    trace(L7, _T("PSButton4=ID<%s>."), csID);
  }
...
SMStateBase *SMUSSFManagerBase::PSButton5(void)
{
  ...
  // Get the ID of the button!
  CString csID;
  long rc = myDisplayShop -> ControlManager.GetDisplayMapElement(_T("Button5"), BUTTON5, csID);
  if (rc != 0)
  {
    //ERRHANDLE(_T("PSXEventError"), _T("Button5"), _T("USSFSelection::PSButton5()"), _T("GetDisplayMapElement()"));
    trace(L5, _T("Unable to Resolve Event Reference; using Default."));
  }
  else
  {
    trace(L7, _T("PSButton5=ID<%s>."), csID);
  }
...
SMStateBase *SMUSSFManagerBase::PSButton6(void)
{
  ...
  // Get the ID of the button!
  CString csID;
  long rc = myDisplayShop -> ControlManager.GetDisplayMapElement(_T("Button6"), BUTTON6, csID);
  if (rc != 0)
  {
    //ERRHANDLE(_T("PSXEventError"), _T("Button6"), _T("USSFSelection::PSButton6()"), _T("GetDisplayMapElement()"));
    trace(L5, _T("Unable to Resolve Event Reference; using Default."));
  }
  else
  {
    trace(L7, _T("PSButton6=ID<%s>."), csID);
  }
...
SMStateBase *SMUSSFManagerBase::PSButton7(void)
{
  ...
  // Get the ID of the button!
  CString csID;
  long rc = myDisplayShop -> ControlManager.GetDisplayMapElement(_T("Button7"), BUTTON7, csID);
  if (rc != 0)
  {
    //ERRHANDLE(_T("PSXEventError"), _T("Button7"), _T("USSFSelection::PSButton7()"), _T("GetDisplayMapElement()"));
    trace(L5, _T("Unable to Resolve Event Reference; using Default."));
  }
  else
  {
    trace(L7, _T("PSButton7=ID<%s>."), csID);
  }
...
SMStateBase *SMUSSFManagerBase::PSButton8(void)
{
  ...
  // Get the ID of the button!
  CString csID;
  long rc = myDisplayShop -> ControlManager.GetDisplayMapElement(_T("Button8"), BUTTON8, csID);
  if (rc != 0)
  {
    //ERRHANDLE(_T("PSXEventError"), _T("Button8"), _T("USSFSelection::PSButton8()"), _T("GetDisplayMapElement()"));
    trace(L5, _T("Unable to Resolve Event Reference; using Default."));
  }
  else
  {
    trace(L7, _T("PSButton8=ID<%s>."), csID);
  }
...
SMStateBase *SMUSSFManagerBase::TimedOut(void)
{
  ...
  SMStateBase *returnState = SMStateBase::TimedOut();
  if (returnState != STATE_NULL)
  {
...
SMStateBase *SMUSSFManagerBase::PerformAction(CString thisAction, bool &bActionTaken)
{
  ...
  typedef SMStateBase *(*ExitCall) (LPCTSTR, vector<LPCTSTR>, SMStateBase *, bool&);
...
SMStateBase *SMUSSFManagerBase::ShowDetails(CString currentContext)
{
  ...
  // Control Choices
  rc = myDisplayShop -> LoadControlChoices(csControlGroup, currentContext, _T(""));

  if (csControlGroup.GetLength() > 0)
  {
	// Display Manager Presentation
	rc = myDisplayShop -> ControlManager.Display();
  }

  // Selection Choices
  rc = myDisplayShop -> LoadSelectionChoices(csSelectGroup, currentContext, _T("GenericChoices"));

  if (csSelectGroup.GetLength() > 0)
  {
	// Display Manager Presentation
	rc = myDisplayShop -> SelectionManager.Display();
  }
...
void SMUSSFManagerBase::DoContextConfig(CString currentContext, CString defaultContext)
{
  ...
  GETUSSFCONTEXTDATA(currentContext, _T(""), _T("SelectGroup"), csSelectGroup);
  ...
  GETUSSFCONTEXTDATA(currentContext, _T(""), _T("ControlGroup"), csControlGroup);
...
SMStateBase *SMUSSFManagerBase::PSReceiptUp(void)
{
  ...
  //SetPendingEvent(_T("ScrollUp"));

  SMStateBase *returnState = STATE_NULL;

  // Subtract lMaxButtons from scroll amount (but not less than zero).
  myDisplayShop -> SelectionManager.ScrollUp();
  long rc = myDisplayShop -> SelectionManager.Display();
  ...
  if (returnState == STATE_NULL)
  {
    // Determine next move!
    //returnState = MakeNextMove();
    returnState = ProcessEvent(_T("ScrollUp"));
  }
...
SMStateBase *SMUSSFManagerBase::PSReceiptDown(void)
{
  ...
  //SetPendingEvent(_T("ScrollDown"));

  SMStateBase *returnState = STATE_NULL;

  // Add lMaxButtons to scroll amount (wrap to zero if necessary).
  myDisplayShop -> SelectionManager.ScrollDown();
  long rc = myDisplayShop -> SelectionManager.Display();
  ...
  if (returnState == STATE_NULL)
  {
    // Determine next move!
    //returnState = MakeNextMove();
    returnState = ProcessEvent(_T("ScrollDown"));
  }
...
SMStateBase *SMUSSFManagerBase::PSKeystroke(const long wParam, const long lParam)
{
  ...
  //csSelectGroup/csControlGroup.
  CString csPendingEvent = _T(""), csData = _T("");
  rc = myDisplayShop -> GetButtonInfo(csDataEntryGroup, csID, csPendingEvent, csData);
  if (rc)
  {
	  //SetPendingEvent(csPendingEvent);
	  USSFutil.SetMetaData(csData);
  ...
  {
	  returnState = SMStateBase::PSKeystroke(wParam, lParam);
  }
...
SMStateBase *SMUSSFManagerBase::PSListLookup(CString csTempID)
{
  SMStateBase *returnState = STATE_NULL;
  CString csID, tempstr;
  long rc = 0;

  ////////////////////////////////////////////////////////////////////////////////////////////
  // Because of the PSThread inflexibility, csID will be a string but will actually be a 
  // numeric index into the appropriate DisplayShop vector. A lookup will be necessary to
  // get the actual ID.
  //
  // If PSThread ever gets improved to the point where states/contexts are not hard-coded,
  // then we may be able to eliminate this indirection.
  ////////////////////////////////////////////////////////////////////////////////////////////

  // Ignore if current selection group is NULL.
  if (myDisplayShop -> SelectionManager.csComponentID.GetLength() <= 0)
  {
	  trace(L5, _T("No Active Selection Group; PSListLookup() Ignored."));
	  return returnState;
  }

  CString currentContext = GetDisplayContext();

  long lButtonIndex = _ttol(csTempID);
  long lButtonReplaced = -1;
  // Get the ID of the button!
  rc = myDisplayShop -> SelectionManager.GetDisplayMapElement(lButtonIndex, csID);
  if (rc != 0)
  {
    ERRHANDLE(_T("SelectionEventError"), _T("Internal Error"), _T("USSFMaster::PSListLookup()"), csTempID);
  }
  else
  {
    trace(L5, _T("Button Index <%d>=ID<%s>."), lButtonIndex, csID);
  }

  long lButtonReplace;
  myDisplayShop -> SelectionManager.Select(lButtonIndex, lButtonReplace);
  myDisplayShop -> SelectionManager.Refresh();

  // Need to get the PendingEvent/POSData from the DisplayShop Object.
  //csSelectGroup/csControlGroup.
  CString csPendingEvent = _T(""), csData = _T("");
  rc = myDisplayShop -> GetButtonInfo(csSelectGroup, csID, csPendingEvent, csData);
  if (!rc)
  {
	  csPendingEvent.Format(_T("SelectButton%d"), lButtonIndex);
  }

  USSFutil.ResolveSymbol(csPendingEvent, csPendingEvent);
  USSFutil.ResolveSymbol(csData, csData);
  //SetPendingEvent(csPendingEvent);
  USSFutil.SetMetaData(csData);
  SetChoiceID(csID);
  //returnState = MakeNextMove();
...
{  
#ifdef _BUILDLIB_
  TBSTATE eState = SMStateBase::TBProcessMessage(me);
#else
  TBSTATE eState = SMState::TBProcessMessage(me);
#endif
...
#ifdef _BUILDLIB_
	SMStateBase* returnState = SMStateBase::TBParse(me);
#else
...
// Local Actions
SMStateBase *SMUSSFManagerBase::USSF_Show2x20_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	TBShow2x20();
	return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_SendScanData_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csTraceStr;
...
SMStateBase *SMUSSFManagerBase::USSF_SellDepartmentItem_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_SellScannedItem_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_SellKeyedItem_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_IgnoreUnknownAction_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_Return_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_Mark_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_Resume_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_Exit_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_LoadDefinition_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_ClearDefinition_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
    trace(L5, _T("Processing Action: %s"), _T("ClearDefinition"));
	CString csTraceStr;
	SMStateBase *returnState = STATE_NULL;

	myDisplayShop -> ClearDefinition();

	return returnState;
}

SMStateBase *SMUSSFManagerBase::USSF_StoreSymbols_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_AmtDueAmtPaid_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_EnableMSR_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  DMMSREnable();   // enable the MSR, turn light on
  return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_DisableMSR_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  DMMSRDisable();   // enable the MSR, turn light on
  return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_CancelItem_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_FormatData_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_EnableScanner_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	DMScannerEnable();
	return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_DisableScanner_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	DMScannerDisable();
	return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_IfTxStart_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_SayAmount_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_SayPhrase_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_SayWave_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_SetDeclineMessage_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_Intervention_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_FireTBDisplay_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_Alert_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	// This will cause a TB Message to be sent as a 2x20 PRIMARYDISPLAY to the TB.
	// Sometimes these are referred to as Fake POS Messages since they do not
	// originate at the POS.
...
SMStateBase *SMUSSFManagerBase::USSF_AssistAlert_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	// This will cause a TB Message to be sent as a 2x20 PRIMARYDISPLAY to the TB.
	// Sometimes these are referred to as Fake POS Messages since they do not
	// originate at the POS.
...
SMStateBase *SMUSSFManagerBase::USSF_SetTimeOut_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	// This will cause a TB Message to be sent as a 2x20 PRIMARYDISPLAY to the TB.
	// Sometimes these are referred to as Fake POS Messages since they do not
	// originate at the POS.
...
SMStateBase *SMUSSFManagerBase::USSF_Trace_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	// This will cause a TB Message to be sent as a 2x20 PRIMARYDISPLAY to the TB.
	// Sometimes these are referred to as Fake POS Messages since they do not
	// originate at the POS.
...
SMStateBase *SMUSSFManagerBase::USSF_IdentifyApproval_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_Sleep_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1, csActionParm2;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_ClearUSSFApproval_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_TBFinish_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	return pOpState -> TBFinish();
}

SMStateBase *SMUSSFManagerBase::USSF_ResetTenderButtons_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	ps.LoadTenderList();
	return STATE_NULL;
}
...
/* BAD
SMStateBase *SMUSSFManagerBase::USSF_SetAnchorState_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1, csActionParm2;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_GoAnchorState_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	return createAnchorState();
}

SMStateBase *SMUSSFManagerBase::USSF_IfApprovalPending_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  SMStateBase *returnState = STATE_NULL;
...
/////////////////////////////////////////////
SMStateBase *SMUSSFManagerBase::USSF_FullReset_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	USSFutil.ResetData(_T("FULL"));
	return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_PartialReset_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	USSFutil.ResetData(_T("PARTIAL"));
	return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_ClearTransactionData_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	USSFutil.ResetData(_T("TRXN"));
	return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_ClearItemData_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	USSFutil.ResetData(_T("ITEM"));
	return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_ClearMetaData_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	USSFutil.ResetData(_T("META"));
	return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_Clear_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1, csActionParm2;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_Append_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1, csActionParm2;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_Store_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1, csActionParm2;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_Parse_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1, csActionParm2;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_SendPOSMessage_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1, csActionParm2;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_DisplayKeyedElement_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csPOSData;
...
SMStateBase *SMUSSFManagerBase::USSF_DisplayKeyedBuffer_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csPOSData;
...
SMStateBase *SMUSSFManagerBase::USSF_DisplayKeyedData_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csPOSData;
	USSFutil.StoreParsedData(_T("@MetaBuffer"), csPOSData, false);
	pOpState -> ShowPOSDisplay(_T(""), csPOSData.Mid(0,20));
...
SMStateBase *SMUSSFManagerBase::USSF_Display_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_ClearDisplay_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	pOpState -> ClearPOSDisplay();
	return STATE_NULL;
}
SMStateBase *SMUSSFManagerBase::USSF_InitAssist_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_ExitAssist_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_NOP_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	return STATE_NULL;
}
SMStateBase *SMUSSFManagerBase::USSF_Set_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_PressButtonX_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_PressGoBack_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
	returnState = pOpState -> PSButtonGoBack();
	return returnState;
}
SMStateBase *SMUSSFManagerBase::USSF_GetDiagFiles_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
	//CString csValue;
...
SMStateBase *SMUSSFManagerBase::USSF_Shutdown_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_STOP;
	//bool rc = pOpState -> LaunchProgram(_T("\\scot\\bin\\GetDiagFiles.exe"), 0, false);
	return returnState;
}
SMStateBase *SMUSSFManagerBase::USSF_DisplayRAP_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_DisplayReceipt_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_GetText_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_EchoInput_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csData;
...
SMStateBase *SMUSSFManagerBase::USSF_EchoData_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_ShowLeadthru_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1, csActionParm2;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_EchoAmount_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	CString csActionCommand, csActionParm1, csActionParm2;
	long lActionParmCount;
	USSFutil.GetTransactionVariable(_T("ActionCommand"), csActionCommand);
...
SMStateBase *SMUSSFManagerBase::USSF_ClearInput_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	ps.ClearInput();
	USSFutil.ResetData(_T("META"));
	return STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_EnableButton_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_DisableButton_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_SetButton_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_ClearControlButtons_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_AllowInput_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_SendRAPMessage_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_GoUSSF_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_IF_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_GoFLState_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_WaitForApproval_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
		CREATE_AND_DISPENSE(WaitForApproval)(false,false);
}
...
SMStateBase *SMUSSFManagerBase::USSF_IfTxBalance_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_SetPSXVariable_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_GetPSXVariable_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_FreezeState_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_UnFreezeState_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_IfFrankingPending_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
  SMStateBase *returnState = STATE_NULL;
  CString csTempstr;
...
SMStateBase *SMUSSFManagerBase::USSF_HandleUSSFApproval_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
	CString csTempstr;
...
SMStateBase *SMUSSFManagerBase::USSF_SuspendTransaction_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
...
SMStateBase *SMUSSFManagerBase::USSF_CancelTransaction_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
	lVisualVerifyItems = 0;
...
SMStateBase *SMUSSFManagerBase::USSF_GetTotalDetails_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
	lVisualVerifyItems = 0;
...
SMStateBase *SMUSSFManagerBase::USSF_GoTo_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
	CString csActionCommand, csActionParms, csTempstr;
	long lActionParmCount;
...
SMStateBase *SMUSSFManagerBase::USSF_EndScript_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_USSF_ENDSCRIPT;
	return returnState;
}

SMStateBase *SMUSSFManagerBase::USSF_SAWLDBScannerDisable_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_SAWLDBScannerEnable_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
...
SMStateBase *SMUSSFManagerBase::USSF_CashAcceptorEnable_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	DMCashAcceptorEnable(co.csTenderDenominations);
	return STATE_NULL;
}
SMStateBase *SMUSSFManagerBase::USSF_CashAcceptorDisable_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	DMCashAcceptorDisable();
	return STATE_NULL;
}
SMStateBase *SMUSSFManagerBase::USSF_CoinAcceptorEnable_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	DMCoinAcceptorEnable();
	return STATE_NULL;
}
SMStateBase *SMUSSFManagerBase::USSF_CoinAcceptorDisable_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	DMCoinAcceptorDisable();
	return STATE_NULL;
}
SMStateBase *SMUSSFManagerBase::USSF_ScaleEnable_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	DMScaleEnable();
	return STATE_NULL;
}
SMStateBase *SMUSSFManagerBase::USSF_ScaleDisable_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	DMScaleDisable();
	return STATE_NULL;
}

SMStateBase *SMUSSFManagerBase::USSF_DumpUSSFSymbols_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
	bool bMeta = true;
...
SMStateBase *SMUSSFManagerBase::USSF_DumpUSSFSymbolsBySerial_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
	bool bMeta = true;
	long lActionParmCount = 0;
...
SMStateBase *SMUSSFManagerBase::USSF_DumpUSSFSymbolsByElementID_Action(SMStateBase *pOpState, vector<LPCTSTR> vParms)
{
	SMStateBase *returnState = STATE_NULL;
	bool bMeta = true;
	long lActionParmCount = 0;
