...
//
// $Archive: /Integration_Customer/Meijer/CURRENT_DEV/Platform-Core-Patch/Core/SCOTAPP/dmx/printer.h $
//
// $Revision: 6 $
//
// $Date: 1/05/10 8:40p $
...
class CPrinterWrapper : public TOPOSPOSPrinter<CGenericOposIF>
   ...
   public:
       ...
       long ChangePrintSide(long nPrintSide);
...
// -RFC 367092 made all these below functions Virtual
      ...
      virtual long BeginRemoval( long lTimeout )
         { ASSERT( FALSE ); return OPOS_E_ILLEGAL; }
      virtual long BeginRemovalForced( long lTimeout )
         { ASSERT( FALSE ); return OPOS_E_ILLEGAL; }
   ...
   protected:
      ...
      virtual long OnChangePrintSide( long nPrintSide) const;
   ...
   private:
      ...
      friend long CChangePrintSideRequest::Process(CPrintStation& rStation ) const;
   };
