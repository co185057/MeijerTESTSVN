...
{
    TRACE_METHOD(_T("RAInterface::CanApprove"));
...
{
    TRACE_METHOD(_T("RAInterface::GetApprovalInfo"));
    trace(L6, _T("bstrInParms: %s"), bstrInParms);
...
{
    TRACE_METHOD(_T("RAInterface::OnApproval"));
    trace(L6, _T("bstrInParms: %s"), bstrInParms);
...
{
    TRACE_METHOD(_T("RAInterface::OnControl"));
	trace(L6, _T("bstrInParms: %s"), MaskedParam( (CString)bstrInParms) );
...
{
    TRACE_METHOD(_T("RAInterface::OnEvent"));
...
{
    TRACE_METHOD(_T("RAInterface::Get"));
    trace(L6, _T("bstrInParms: %s"), bstrInParms);
...
{
    TRACE_METHOD(_T("RAInterface::Set"));
    trace(L6, _T("bstrInParms: %s"), bstrInParms);
...
{
    TRACE_METHOD(_T("RAInterface::OnInputEvent"));
    trace(L6, _T("bstrInParms: %s"), bstrInParms);
...
//  mo.PostRCMgr( SmOnItemOK, csParms); 
    ...
    //SOTF 7183
    CString csOpID = SMStateBase::getOperatorID(m_RequestApprovalParms.m_csRemoteConnection);
    ...
    {
	    _tcscpy(mePtr->raInfo.operatorID, SMStateBase::getOperatorID(m_RequestApprovalParms.m_csRemoteConnection));
    }
    //sotf	
...
{
    TRACE_METHOD(_T("RAInterface::IsRemoteMode"));
    trace(L6,_T("IsRemoteMode returns=%s"), (m_eRemoteMode == ACCEPTED ? _T("true") : _T("false")));
...
{
    TRACE_METHOD(_T("RAInterface::AcceptConnection"));
...
{
    TRACE_METHOD(_T("RAInterface::DisconnectFromServer"));
    m_eRemoteMode = DISCONNECTED;
}
