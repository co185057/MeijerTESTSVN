...
namespace SharpZip {
	...
	public class SharpZipArchiver {
...
#else
										System.Console.WriteLine("-e cannot be in a group");
#endif
									} 
									else 
									{
...
#else
			Console.WriteLine("SharpZip Archiver v0.34   Copyright 2004 John Reilly");
#endif
		...
		void ShowHelp()
		{
			...
			Console.WriteLine("-p                         Store relative path info");
