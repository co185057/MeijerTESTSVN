...
namespace LaunchPadNet
{
  ...
  public class Button
  {
    ...
    private String m_sToggleStateOnDeadMainAndCompanionExecutables;
    private String m_sToggleStateOnAliveMainAndCompanionExecutables;
    private String m_sToggleStateOnDeadMainAndCoAndCompanionExecutables;
    private String m_sToggleStateOnAliveMainAndCoAndCompanionExecutables;
    private String m_sToggleStateOnDeadMainAndCoExecutables;
    private String m_sToggleStateOnAliveMainAndCoExecutables;
    ...
    public String ToggleStateOnDeadMainAndCoExecutables
    {
        get
        {
            return this.m_sToggleStateOnDeadMainAndCoExecutables;
        }
    
        set
        {
            this.m_sToggleStateOnDeadMainAndCoExecutables = value;
        }
    }

    public String ToggleStateOnAliveMainAndCoExecutables
    {
        get
        {
            return this.m_sToggleStateOnAliveMainAndCoExecutables;
        }

        set
        {
            this.m_sToggleStateOnAliveMainAndCoExecutables = value;
        }
    }

    public String ToggleStateOnDeadMainAndCompanionExecutables
    {
      get
      {
        return this.m_sToggleStateOnDeadMainAndCompanionExecutables;
      }
        
      set
      {
          this.m_sToggleStateOnDeadMainAndCompanionExecutables = value;
      }
    }
    
    public String ToggleStateOnAliveMainAndCompanionExecutables
    {
      get
      {
          return this.m_sToggleStateOnAliveMainAndCompanionExecutables;
      }

      set
      {
          this.m_sToggleStateOnAliveMainAndCompanionExecutables = value;
      }
    }

    public String ToggleStateOnDeadMainAndCoAndCompanionExecutables
    {
        get
        {
            return this.m_sToggleStateOnDeadMainAndCoAndCompanionExecutables;
        }
    
        set
        {
            this.m_sToggleStateOnDeadMainAndCoAndCompanionExecutables = value;
        }
    }

    public String ToggleStateOnAliveMainAndCoAndCompanionExecutables
    {
        get
        {
            return this.m_sToggleStateOnAliveMainAndCoAndCompanionExecutables;
        }

        set
        {
            this.m_sToggleStateOnAliveMainAndCoAndCompanionExecutables = value;
        }
    }
