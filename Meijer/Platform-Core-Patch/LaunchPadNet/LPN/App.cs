...
namespace LaunchPadNet
{
	...
	public class App
	{
        ...
        private String m_sCoExecutable="";
        private String m_sCoExecutableContext="";
        private String m_sCoExecutableContextNotLoaded="";
        ...
        private bool m_bMonitorCoExecutable = false;
        private bool m_bMonitorCompanionExecutable = false;
        ...
        private Executable m_appCoExecutable=null;
        ...
        public Executable AppCoExecutable
        {
            set
            {
                this.m_appCoExecutable  =value;
            }
            get
            {
                return this.m_appCoExecutable;
            }
        }
        ...
        public string CoExecutable
        {
            get
            {
                return this.m_sCoExecutable ; 
            }
            set
            {
                this.m_sCoExecutable=value;
            }
        }

        public string CoExecutableContext
        {
            get
            {
                return this.m_sCoExecutableContext; 
            }
            set
            {
                this.m_sCoExecutableContext=value;
            }
        }

        public string CoExecutableContextNotLoaded
        {
            get
            {
                return this.m_sCoExecutableContextNotLoaded; 
            }
            set
            {
                this.m_sCoExecutableContextNotLoaded=value;
            }
        }
        ...
        public bool MonitorCoExecutable
        {
            get
            {
                return this.m_bMonitorCoExecutable; 
            }
            set
            {
                this.m_bMonitorCoExecutable =value;
            }
        }

        public bool MonitorCompanionExecutable
        {
            get
            {
                return this.m_bMonitorCompanionExecutable; 
            }
            set
            {
                this.m_bMonitorCompanionExecutable =value;
            }
        }
