...
// (-) POS101386
		...
		public CAppSettings()
		{
            m_strPrdWebServiceTemplate = ConfigurationManager.AppSettings["PrdWebServiceTemplate"];
            m_strCertWebServiceTemplate = ConfigurationManager.AppSettings["CertWebServiceTemplate"];
            m_strDevWebServiceTemplate = ConfigurationManager.AppSettings["DevWebServiceTemplate"];
            string str = ConfigurationManager.AppSettings["LabStoreNumbers"]; // POS100102
			string strMachineName = System.Environment.MachineName;
            m_strWebServiceTemplate = ConfigurationManager.AppSettings["WebServiceTemplate"]; // POS101386
//(+) POS100102
