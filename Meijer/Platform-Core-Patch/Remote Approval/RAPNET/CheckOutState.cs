...
namespace RapNet
{
    ...
    internal class CheckOutState : RapNet.SignOnState
    {
        ...
        public void ProcessCheckOut( string param )
        {
            ...
            {
                ConfigData configData = ConfigDataRapNet.GetConfigData();
                checkOutTimer = new System.Threading.Timer( new TimerCallback( CheckOutTimeout ), null, configData.SignOnTimeout, Timeout.Infinite );
        ...
        public override void State_ScannerEvent( object sender, ScannerEventArgs e )
        {
			...
			Remote.SendMessage( ConfigDataRapNet.launchpadApplication, "operation=reset-autosignoff" );
