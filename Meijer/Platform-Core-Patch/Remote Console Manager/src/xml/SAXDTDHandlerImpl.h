...
class UTILS_API SAXDTDHandlerImpl 
...
private:
    ...
    SAXDTDHandlerImpl(const SAXDTDHandlerImpl &);               // Hide the Copy construcor
    SAXDTDHandlerImpl &operator =(const SAXDTDHandlerImpl &);   // Hide the assignment operator
};
