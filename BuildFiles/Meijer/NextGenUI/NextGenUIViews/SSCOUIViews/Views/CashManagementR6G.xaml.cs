// <copyright file="CashManagementR6G.xaml.cs" company="NCR">
//     Copyright 2018 NCR. All rights reserved.
// </copyright>
...
namespace SSCOUIViews.Views
{
    ...
    /// <summary>
    /// Interaction logic for CashManagementR6G.XAML
    /// </summary>
    public partial class CashManagementR6G : BackgroundView
    {
        private ObservableCollection<ReceiptItem> loaderObject = new ObservableCollection<ReceiptItem>();

        /// <summary>
        /// Initializes a new instance of the CashManagementR6G class.
        /// </summary>
        /// <param name="viewModel">ViewModel object.</param>
        public CashManagementR6G(IMainViewModel viewModel)
            : base(viewModel)
        {
            InitializeComponent();
        }
        ...
        private void CashManagementR6G_Unloaded(object sender, RoutedEventArgs e)
        {
