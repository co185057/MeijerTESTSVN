...
MessageID=8000
SymbolicName=TRANS_BROKER_NOT_INITIALIZED
Language=English
...
MessageID=
SymbolicName=TRANS_BROKER_EXIT
Language=English
Transaction Broker was closed.
.

MessageID=
SymbolicName=TB_EID_NO_VERSIONINFO
Language=English
Transaction Broker could not get version information.
.

MessageID=
SymbolicName=TB_INITIALIZED
Language=English
Transaction Broker (emulator) is successfully initialized.
.

MessageID=
SymbolicName=TB_MISSING_PLU_LIST
Language=English
Missing PLU List File.
.

MessageID=
SymbolicName=TB_MISSING_DISPLAY_TEXT
Language=English
Missing Display Text Table File.
.

MessageID=
SymbolicName=TB_MISSING_EXCEPT_LIST
Language=English
